...
""",
    ...
    "smolvlm-256m-sft": RecipeMeta(
        ...
        "SmolVLM uses an Idefics3 processor; Kadhi mirrors its nested tokenizer "
...
training:
  ...
  rollout_func: kadhi_cli.envs.calculator:rollout
...
training:
  ...
  reward_fn: accuracy
  rollout_backend: openenv
  rollout_func: kadhi_cli.envs.retrieval_qa:rollout
...
training:
  ...
  verifiable_domain: math
  rollout_backend: openenv
  rollout_func: kadhi_cli.envs.guess_number:rollout
