...
class _KadhiTrainerCallback_body:  # noqa: N801
    ...
    def _run_eval_gate(self, state: TrainerState, control: TrainerControl) -> None:
        ...
        from kadhi_cli.eval.gate import run_gate as _default_run_gate
    ...
    def _run_auto_eval(self) -> None:
        ...
        if benchmarks:
            try:
                from kadhi_cli.commands.eval import benchmark
                benchmark(
    ...
    def _write_spike_recovery_hint(self, args, loss: float) -> None:
        ...
        # by KadhiConfig but args.output_dir from raw HF TrainingArguments is
...
_LAZY_CALLBACKS = {
    "KadhiTrainerCallback": _KadhiTrainerCallback_body,
}
