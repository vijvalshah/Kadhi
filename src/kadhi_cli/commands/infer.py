...
def _build_asr_transcriber(
    ...
    """
    from kadhi_cli.trainer.asr import _require_whisper_base, read_asr_sidecar
    ...
    from kadhi_cli.utils.trust_remote import resolve_trust_remote_code
    ...
    from kadhi_cli.utils.trust_remote import model_requires_trust_remote_code
...
def _infer_asr(
    *,
    ...
    from kadhi_cli.utils.asr_metrics import cer, corpus_wer, wer
