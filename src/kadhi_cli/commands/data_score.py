...
helpers from ``kadhi_cli/utils/data_score.py``, and writes an enriched
...
def _write_rows(rows: Iterable[Mapping[str, Any]], path: str) -> str:
    from kadhi_cli.utils.data_score import write_jsonl_rows
...
def score(
    ...
    from kadhi_cli.utils.data_score import BENCHMARKS, compute_scorecard
...
def decontaminate(
    ...
    """
    from kadhi_cli.utils.data_score import (
        BENCHMARKS,
        decontaminate_rows,
        extract_row_text,
        load_jsonl_rows,
...
def toxicity(
    ...
    from kadhi_cli.utils.data_score import extract_row_text, score_abuse_keywords
...
def langdetect(
    ...
    from kadhi_cli.utils.data_score import detect_language, extract_row_text
...
def pii(
    ...
    from kadhi_cli.utils.data_score import detect_pii, extract_row_text
...
def educational(
    ...
    from kadhi_cli.utils.data_score import extract_row_text, score_educational_value
