...
def _run_dedup_pipeline(path: Path) -> None:
    ...
    try:
        ...
        console.print(
            ...
            "Install: pip install \"kadhi-cli\\[data]\"[/]"
        )
...
def _generate_batch(
    ...
    if provider == "openai":
        ...
        from kadhi_cli.data.providers.ollama import DEFAULT_OLLAMA_BASE, generate_ollama
        ...
        from kadhi_cli.data.providers.vllm import DEFAULT_VLLM_BASE, generate_vllm
...
def _generate_local(
    ...
    from kadhi_cli.utils.vllm import encode_rendered_prompt
...
def _parse_json_array(content: str) -> list[dict]:
    ...
    Delegates to kadhi_cli.data.providers._utils.parse_json_array to avoid
