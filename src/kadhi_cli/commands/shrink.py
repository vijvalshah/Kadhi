...
from kadhi_cli.utils.adapter_fuse import fuse_adapter_into as _fuse_adapter
from kadhi_cli.utils.adapter_fuse import release_cuda as _release_cuda
...
def _render_importance_table(
    ...
    table = Table(title="kadhi shrink — layer importance (lower = safer to drop)")
