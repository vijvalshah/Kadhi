"""kadhi expect — Expectations suite for chat data (v0.69.0 Part B).
...
def expect_cmd(
    ...
    """
    from kadhi_cli.utils.expectations import load_suite_yaml, run_suite
    ...
    table = Table(title=f"kadhi expect — {escape(data)}")
