...
from kadhi_cli.utils._eval_text import row_text
...
from kadhi_cli.utils.topics import build_topic_report, kmeans, resolve_k

console = Console()


def _report_to_dict(report) -> dict:
    """JSON-safe rendering of a :class:`~kadhi_cli.utils.topics.TopicReport`."""
    return {
...
def topics(
    ...
    try:
        ...
        console.print(
            "[red]kadhi data topics needs PyTorch + transformers.[/]\n"
