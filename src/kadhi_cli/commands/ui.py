...
def ui(
    ...
    from kadhi_cli.ui.app import create_app, get_auth_token, set_auth_token
    ...
    if public:
        ...
        from kadhi_cli.utils.qr_url import render_qr_ascii
