"""kadhi airgap-bundle — build a one-shot offline tarball (v0.60.0 Part F)."""
...
def airgap_bundle(
    ...
    repro_receipt: Optional[str] = typer.Option(
        None, "--repro-receipt",
        help=(
            "Embed a reproducibility receipt JSON (from `kadhi train "
    ...
    console.print(
        Panel(
            ...
            f"Kadhi ver:    {escape(manifest.kadhi_version)}\n"
