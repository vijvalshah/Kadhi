...
from kadhi_cli.utils.audit_log import default_log_path, read_audit_tail, rotate_if_needed
...
def tail_cmd(
    ...
    path: Optional[str] = typer.Option(
        None, "--path",
        help="Override audit log path (default: $KADHI_AUDIT_LOG_PATH "
             "or ~/.kadhi/audit.jsonl).",
    ),
    ...
    if not records:
        ...
        return
    table = Table(title="kadhi audit-log tail")
