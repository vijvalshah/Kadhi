"""kadhi recipes — browse and use ready-made configs for popular models."""
...
def list_cmd():
    ...
    table = Table(title="Kadhi Recipes")
...
def show(
    ...
    if recipe is None:
        ...
        console.print("[dim]Run 'kadhi recipes list' to see all recipes.[/]")
        raise typer.Exit(1)
...
def search(
    ...
    if not results:
        ...
        console.print(f"[dim]Available recipes: {len(RECIPES)}. Run 'kadhi recipes list'.[/]")
        return
