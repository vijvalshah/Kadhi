...
def init(
    ...
    console.print(
        Panel(
            ...
            f"Next step: [bold]kadhi train --config {output_path}[/]",
            title="Ready!",
        )
    )
...
def _interactive_wizard() -> str:
    ...
    console.print(Panel("[bold]Kadhi Config Wizard[/]", subtitle="Let's set up your training"))
...
"""
    ...
    return f"""# Kadhi training config
# Docs: https://trykadhi.dev
