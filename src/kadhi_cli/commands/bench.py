...
def bench(
    ...
    from kadhi_cli.commands.infer import _generate, _load_model, _resolve_model_source
    ...
    from kadhi_cli.utils.backend_detect import SUPPORTED_BACKENDS, detect_backend
