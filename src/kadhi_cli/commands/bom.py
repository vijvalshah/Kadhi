...
from kadhi_cli.utils.bom import BomEntry, attach_energy, render_bom, write_bom
...
def emit_cmd(
    ...
    config_sha: str = typer.Option(
        ..., "--config-sha", help="SHA-256 of the resolved kadhi.yaml config.",
    ),
    ...
    output: Optional[str] = typer.Option(
        ...
        help=("Output file path (cwd-contained). When --format=both, "
              "this is the prefix and Kadhi writes <prefix>.cdx.json + "
              "<prefix>.spdx.json."),
    ),
