"""kadhi autopilot — zero-config fine-tuning (Part H of v0.25.0)."""
...
from kadhi_cli.autopilot.decisions import GOAL_TO_TASK, parse_gpu_budget
...
def autopilot_cmd(
    ...
    output: str = typer.Option(
        "kadhi.yaml", "--output", "-o", help="Output config path",
    ),
    ...
    """Autopilot: give model+data+goal, Kadhi picks optimal hyperparameters."""
