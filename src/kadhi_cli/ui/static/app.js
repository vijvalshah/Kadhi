/* Kadhi Web UI — Frontend Application */
  ...
  document.getElementById('dashboard-content').innerHTML = `
    ...
    <div class="card">
      ...
      <div style="font-size:0.9rem; color: var(--text-dim)">
        ...
        Kadhi: <strong style="color:var(--text)">v${escapeHtml(systemInfo.version)}</strong>
      </div>
    </div>
    ...
    <div class="card">
      ...
      ${runsData.length === 0
        ? '<div class="empty-state"><div class="empty-state-text">No runs yet</div><div class="empty-state-hint">Start training with "kadhi train" or use the New Training page</div></div>'
    ...
    <div class="grid-2">
      <div>
        ...
        <div class="card">
          ...
          <textarea id="${editorId}" rows="22" placeholder="Paste your kadhi.yaml config here or select a template...">${templates[templateNames[0]] || ''}</textarea>
        </div>
