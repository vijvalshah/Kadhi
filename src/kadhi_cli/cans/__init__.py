"""Kadhi Cans — shareable .can artifact format (v0.26.0 Part E).

A ``.can`` file is a tar.gz containing:
  manifest.yaml      — format version, name, author, etc.
  config.yaml        — full KadhiConfig
...
from kadhi_cli.cans.schema import CAN_FORMAT_VERSION, DataRef, Manifest
