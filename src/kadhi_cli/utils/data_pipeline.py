...
# an entry in ``kadhi_cli.data.formats._convert_*`` (Part A live wiring) and
...
_PROMPT_STRATEGY_LOG = logging.getLogger("kadhi_cli.utils.data_pipeline.prompt_strategy")
