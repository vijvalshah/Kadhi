...
:func:`kadhi_cli.utils.embed.embed_texts`), so every decision here is
    ...
    *,
    ...
    if n_rows > _MAX_TOPIC_ROWS:
        raise ValueError(
            ...
            "first — Kadhi refuses rather than silently subsampling."
        )
    if n_rows == 0:
...
def build_topic_report(
    ...
    *,
    ...
    from kadhi_cli.utils._eval_text import row_text, tokenize
