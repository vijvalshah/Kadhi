...
from kadhi_cli.utils._eval_text import row_text as _row_text
from kadhi_cli.utils._eval_text import tokenize as _tokenize
...
def write_eval_design(design: EvalDesign, output_path: str) -> str:
    ...
    fd, tmp = tempfile.mkstemp(prefix=".kadhi-eval-design.", dir=parent)
    try:
