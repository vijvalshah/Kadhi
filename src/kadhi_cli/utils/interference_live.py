...
The v0.66.0 :mod:`kadhi_cli.utils.interference` matrix builder consumes a dict of
...
and in :mod:`kadhi_cli.utils.live_eval`; importing this module is cheap.
...
from kadhi_cli.utils.interference import _MAX_ADAPTERS, _MIN_ADAPTERS
...
def measure_interference_losses(
    ...
    *,
    ...
    :func:`kadhi_cli.utils.interference.build_interference_matrix`.
    """
