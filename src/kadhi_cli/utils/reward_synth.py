"""Reward-verifier synthesis — `kadhi reward synth` (v0.71.40).
...
:func:`kadhi_cli.trainer.rewards.load_reward_fn`'s existing ``.py`` path — NO new
...
# Source rendering
# ---------------------------------------------------------------------------
_HEADER = '''"""Deterministic reward verifier — generated by `kadhi reward synth` (v0.71.40).
