...
benign ones. Built on the shared :mod:`kadhi_cli.utils.probe_kernel`: the real
...
from kadhi_cli.utils.probe_kernel import (  # noqa: F401 — re-exported for #217
    PROBE_VERDICTS,
    ProbeResult,
    ProbeSpec,
    apply_linear_probe,
...
# mild + non-operational — Kadhi does not ship operational misuse instructions.
