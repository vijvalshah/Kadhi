...
_LENGTHS_ATTR = "_kadhi_multipack_lengths"
_MAX_SEQ_ATTR = "_kadhi_multipack_max_seq_len"
_BATCH_SIZE_ATTR = "_kadhi_multipack_batch_size"
_SEED_ATTR = "_kadhi_multipack_seed"
