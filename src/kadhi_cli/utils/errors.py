...
_TRAIN_FIX = "Training needs the \\[train] extra. Run: pip install \"kadhi-cli\\[train]\""
...
ERROR_MAP = [
    ...
    (
        ...
        "FastAPI is not installed (needed for kadhi serve).",
        "Run: pip install \"kadhi-cli\\[serve]\"",
    ),
    (
        "No module named 'uvicorn'",
        "Uvicorn is not installed (needed for kadhi serve).",
        "Run: pip install \"kadhi-cli\\[serve]\"",
    ),
    (
        "No module named 'datasketch'",
        "Datasketch is not installed (needed for dedup).",
        "Run: pip install \"kadhi-cli\\[data]\"",
    ),
    (
        "No module named 'lm_eval'",
        "lm-evaluation-harness is not installed (needed for eval).",
        "Run: pip install \"kadhi-cli\\[eval]\"",
    ),
    (
    ...
    (
        ...
        "Run: pip install \"kadhi-cli\\[deepspeed]\"",
    ),
    (
        "No module named 'httpx'",
        "httpx is not installed (needed for data generate).",
        "Run: pip install \"kadhi-cli\\[generate]\"",
    ),
    ...
    (
        ...
        "Run: pip install torchvision --force-reinstall (or check kadhi doctor).",
    ),
    ...
    (
        ...
        (
            ...
            "demands). Kadhi does not need torchao unless you set "
    ...
    (
        ...
        "Check the file path. Run 'kadhi init' to create a config.",
    ),
    # YAML errors
    (
        "yaml.scanner.ScannerError",
        "Invalid YAML syntax in config file.",
        "Check your kadhi.yaml for syntax errors (indentation, colons, quotes).",
    ),
    # Pydantic validation
    (
        "validation error",
        "Config validation failed.",
        "Check your kadhi.yaml values. Run 'kadhi init' to generate a valid config.",
    ),
