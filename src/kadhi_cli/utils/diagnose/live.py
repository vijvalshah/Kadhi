...
:mod:`kadhi_cli.utils.live_eval`; importing this module is cheap.
...
from kadhi_cli.utils.diagnose.runner import build_report, neutral_score
from kadhi_cli.utils.live_eval import token_f1
from kadhi_cli.utils.paths import enforce_under_cwd_and_no_symlink

if TYPE_CHECKING:
    from kadhi_cli.utils.diagnose.report import FailureReport
...
def run_live_diagnose(
    ...
    * **contamination** — pure data overlap (no model; empty benchmark corpus
    ...
    from kadhi_cli.utils.diagnose.format import score_format
    ...
    from kadhi_cli.utils.diagnose.refusal import score_refusal
    ...
    if rows:
        from kadhi_cli.utils.diagnose.citation import is_raft_row, score_citation
