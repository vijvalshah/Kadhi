...
def supports_multipack(task: str) -> bool:
    ...
    Mirrors :func:`kadhi_cli.utils.v028_features.supports_v028_features`
    naming and shape so ``KadhiConfig`` validators stay symmetric.
    """
    ...
    *,
    ...
    if isinstance(raw_batch_size, str):
        raise ValueError(
            ...
            "kadhi_cli.utils.batch_probe.pick_batch_size)."
        )
