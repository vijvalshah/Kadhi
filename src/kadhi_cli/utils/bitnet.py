...
def build_bitnet_trainer(config: object, **kwargs: object):
    ...
    Returns a :class:`~kadhi_cli.trainer.bitnet.BitNetTrainerWrapper`. BitNet
    ...
    Lazy import keeps ``kadhi_cli.utils.bitnet`` torch-free.
    """
...
def export_bitnet_gguf(
    *,
    ...
    with tempfile.TemporaryDirectory(
        prefix=".kadhi_bitnet_gguf_", dir=str(Path.cwd()),
    ) as staged:
