...
from kadhi_cli.utils.blame import parse_budget
...
def build_cmaes_eval_fn(
    ...
    *,
    ...
    from kadhi_cli.utils.adapter_merge import merge_linear, write_merged_adapter
    ...
    def _eval_fn(weights: Tuple[float, ...]) -> float:
        ...
        tmp_dir = tempfile.mkdtemp(prefix=".kadhi_cmaes_")
        try:
