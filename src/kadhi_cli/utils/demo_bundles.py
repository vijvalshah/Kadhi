...
_BUNDLES: Mapping[str, DemoBundle] = MappingProxyType({
    ...
    "grpo_demo": DemoBundle(
        ...
        # Alpaca-shaped rows; "reasoning" is not a format Kadhi accepts.
...
def _bundle_source_path(bundle: DemoBundle) -> str:
    ...
    v0.53.8 #93 — fixtures live under ``kadhi_cli/data/_fixtures/`` (package
    ...
    # 1) Preferred — package data at kadhi_cli/data/_fixtures/.
