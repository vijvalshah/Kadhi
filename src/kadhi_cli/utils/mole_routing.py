...
- New ``task='moe_lora_routing'`` Literal on ``KadhiConfig.task``
...
# ---------------------------------------------------------------------------
# Cross-validator (called from KadhiConfig + standalone)
# ---------------------------------------------------------------------------
...
class LoadedMole:
    ...
    (:func:`kadhi_cli.trainer.mole_routing.make_mole_trainer_class`): the base
