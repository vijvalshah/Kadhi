...
try:
    ...
    raise ImportError(
        "textual is required for `kadhi tui`; install with `pip install textual`"
    ) from exc


from rich.markup import escape as markup_escape

from kadhi_cli.utils.replay import summarise
...
class KadhiTuiApp(App):  # type: ignore[misc]
    ...
    def __init__(self, *, refresh_secs: float = 1.0, run_limit: int = 50) -> None:
        ...
        # access to the default `~/.kadhi` dir.
