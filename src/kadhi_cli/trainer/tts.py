...
:class:`~kadhi_cli.trainer.sft.SFTTrainerWrapper` for model/tokenizer/LoRA/CE
...
Security / robustness:
- Family validated via :func:`kadhi_cli.utils.tts.validate_tts_family` before
  any model load.
...
from kadhi_cli.trainer.sft import SFTTrainerWrapper, console
