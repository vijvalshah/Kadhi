...
optimises the per-method loss from :mod:`kadhi_cli.utils.unlearn_kernels`.
...
class UnlearnTrainerWrapper:
    ...
    def __init__(self, config: Any, **kwargs: Any) -> None:
        try:
            ...
            raise AttributeError(
                "UnlearnTrainerWrapper requires a KadhiConfig with "
    ...
    def train(self, **kwargs: Any) -> dict:
        ...
        from kadhi_cli.utils.live_eval import _tokenize_pair
    ...
    def _step_preference(self, tokenize_pair, prompt, target, method, dev):
        ...
        from kadhi_cli.utils.unlearn_kernels import (
            npo_loss,
            sequence_lengths,
            sequence_logprob,
            simnpo_loss,
