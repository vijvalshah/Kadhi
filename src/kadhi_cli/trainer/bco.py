...
if TYPE_CHECKING:
    from kadhi_cli.config.schema import TrainingConfig  # noqa: F401
...
class BCOTrainerWrapper:
    """High-level wrapper for BCO training from KadhiConfig.

    BCO uses a binary classifier objective (chosen vs rejected). Kadhi
    ...
    def setup(self, dataset: dict) -> None:
        ...
        from kadhi_cli.trainer._trl_compat import (
    ...
    def _setup_transformers(self, cfg: KadhiConfig, tcfg: "TrainingConfig") -> None:
    ...
    def _setup_unsloth(self, cfg: KadhiConfig, tcfg: "TrainingConfig") -> None:
