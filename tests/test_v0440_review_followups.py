...
from kadhi_cli.commands.llama import _LLAMA_ENV_ALLOWLIST, _filtered_env
from kadhi_cli.ui.plugins import (
    clear_tabs,
    list_tabs,
    load_plugins,
    register_tab,
)
from kadhi_cli.utils.checkpoint_trigger import write_trigger
from kadhi_cli.utils.delinearize_llama4 import discover_weight_files
from kadhi_cli.utils.fetch_examples import fetch_examples_dir
from kadhi_cli.utils.fsdp_consolidate import discover_shards, plan_consolidation
from kadhi_cli.utils.gpu_monitor import (
    detect_apple_silicon,
    query_nvidia_smi,
)
from kadhi_cli.utils.llama_proxy import resolve
from kadhi_cli.utils.llama_server_timings import format_kv_bar, parse_timings
from kadhi_cli.utils.onboarding import render_onboarding_yaml
from kadhi_cli.utils.qr_url import build_phone_url, render_qr_ascii, validate_token
from kadhi_cli.utils.shortcuts import (
    build_macos_command_file,
    build_windows_cmd,
)
from kadhi_cli.utils.sweep_config import parse_sweep_yaml
from kadhi_cli.utils.tail_latency import percentile, summarise_latency, update_ema
from kadhi_cli.utils.tool_outputs import ToolCallTimer, ToolOutputsBuffer
from kadhi_cli.utils.ui_env import resolve_ui_env
...
def test_tool_outputs_ring_drops_oldest_after_overflow():
    ...
    from kadhi_cli.utils.tool_outputs import _MAX_RECORDS
...
def test_graceful_save_restore_idempotent(monkeypatch):
    ...
    from kadhi_cli.utils.graceful_save import GracefulSaveHandler
