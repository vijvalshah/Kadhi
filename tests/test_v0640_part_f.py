...
def test_module_imports():
    from kadhi_cli.utils import license_advisor
...
def test_deploy_targets_exact():
    from kadhi_cli.utils.license_advisor import DEPLOY_TARGETS
...
def test_validate_deploy_target_happy(v):
    from kadhi_cli.utils.license_advisor import validate_deploy_target
...
def test_license_recommendation_frozen():
    from kadhi_cli.utils.license_advisor import LicenseRecommendation
...
def test_advise_license_b2c():
    from kadhi_cli.utils.license_advisor import advise_license_for_target
...
def test_downstream_risk_frozen():
    from kadhi_cli.utils.license_advisor import DownstreamRisk
...
def test_flag_downstream_risk_unknown_license_warns():
    ...
    r = flag_downstream_risk(
        license_id="unknown-kadhi-test-license", target="b2c", monthly_active_users=1
    )
...
def test_no_heavy_top_level_imports():
    ...
    src = (
        ...
        / "src" / "kadhi_cli" / "utils" / "license_advisor.py"
    )
