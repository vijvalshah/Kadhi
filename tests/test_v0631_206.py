"""Closes #206 — Variance-based diversity score for K>2 reward models in kadhi data active-sample.
...
def test_max_rm_scores_constant_is_32():
    ...
    from kadhi_cli.utils.active_sampler import _MAX_RM_SCORES
...
def test_row_uncertainty_k3_uses_variance_not_max_minus_min():
    ...
    """
    from kadhi_cli.utils.active_sampler import _row_uncertainty
...
def test_sample_uncertain_rows_triple_rm(tmp_path, monkeypatch):
    ...
    from kadhi_cli.utils.active_sampler import sample_uncertain_rows
