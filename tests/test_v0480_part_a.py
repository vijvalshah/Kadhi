...
- Schema: ``curriculum_dynamic`` requires ``curriculum=True``; mlx + non-SFT
  rejection at KadhiConfig level.
- ``kadhi runs curriculum-curve`` CLI smoke.
"""
...
from kadhi_cli.utils.curriculum_dynamic import (
    BucketStats,
...
def test_curriculum_curve_history_outside_cwd(tmp_path, monkeypatch):
    ...
    import kadhi_cli.experiment.tracker as et
...
def test_render_curve_caps_history_rows():
    ...
    import kadhi_cli.utils.curriculum_dynamic as cd
