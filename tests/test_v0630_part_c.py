...
def test_module_imports():
    from kadhi_cli.utils import active_sampler
...
def test_pick_top_uncertain_orders_descending():
    from kadhi_cli.utils.active_sampler import pick_top_uncertain
...
def test_active_learning_plan_frozen():
    from kadhi_cli.utils.active_sampler import ActiveLearningPlan
