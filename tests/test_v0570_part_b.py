...
from kadhi_cli.utils.adapter_merge import (
...
def test_supported_strategies_immutable():
    ...
    from kadhi_cli.utils.adapter_merge import STRATEGY_ORDER
...
def test_no_top_level_torch_import_in_merge():
    src = (Path(__file__).parent.parent / "src" / "kadhi_cli" / "utils" / "adapter_merge.py"
...
def test_adapters_merge_cli_help():
    result = runner.invoke(kadhi_app, ["adapters", "merge", "--help"])
