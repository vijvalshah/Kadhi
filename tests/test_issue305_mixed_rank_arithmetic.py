...
The v0.71.34 ``kadhi adapters arithmetic`` does a signed *element-wise* merge over
...
class TestMergeConcat:
    def test_mixed_rank_add_reconstructs_exactly(self):
        from kadhi_cli.utils.adapter_arithmetic import merge_task_arithmetic_concat
...
class TestReadAdapterScaling:
    def test_reads_scaling(self, tmp_path, monkeypatch):
        from kadhi_cli.utils.adapter_arithmetic import read_adapter_lora_scaling
