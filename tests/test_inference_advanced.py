...
class TestPrefixCachingCLI:
    ...
    def test_serve_prefix_cache_default_false(self):
        from kadhi_cli.commands.serve import serve
...
class TestPrefixCachingEngine:
    ...
    def test_create_engine_passes_prefix_cache_to_vllm(self):
        ...
        with patch.dict("sys.modules", {
            ...
            import kadhi_cli.utils.vllm as vllm_mod
...
class TestStructuredOutput:
    ...
    def test_validate_json_schema_accepts_dict(self):
        from kadhi_cli.utils.structured_output import validate_json_schema
    ...
    def test_validate_regex_pattern_rejects_redos(self):
        ...
        from kadhi_cli.utils.structured_output import validate_regex_pattern
...
class TestRequestTracing:
    ...
    def test_is_otel_available_when_missing(self):
        from kadhi_cli.utils.tracing import is_otel_available
    ...
    def test_build_tracer_returns_none_when_otel_missing(self):
        ...
        with patch(
            "kadhi_cli.utils.tracing.is_otel_available", return_value=False
        ):
...
class TestAutoQuant:
    ...
    def test_candidate_order_default(self):
        from kadhi_cli.utils.auto_quant import default_candidate_order
    ...
    def test_pick_best_candidate_prefers_fastest_ok(self):
        from kadhi_cli.utils.auto_quant import Candidate, pick_best
    ...
    def test_candidate_requires_positive_latency(self):
        from kadhi_cli.utils.auto_quant import Candidate
    ...
    def test_pick_best_empty_list(self):
        from kadhi_cli.utils.auto_quant import pick_best
