"""Tests for v0.60.0 Part A — `kadhi adapters scan` (weight-space backdoor detector).
...
class TestSpectralKernels:
    def test_imports(self):
        from kadhi_cli.utils.adapter_scan import (
            ScanFinding,
            ScanReport,
    ...
    def test_compute_spectral_features_uniform_matrix_no_dominance(self):
        from kadhi_cli.utils.adapter_scan import compute_spectral_features
...
class TestScanAdapterWeights:
    def test_clean_weights_pass(self):
        from kadhi_cli.utils.adapter_scan import scan_adapter_weights
    ...
    def test_scan_finding_frozen(self):
        from kadhi_cli.utils.adapter_scan import ScanFinding
    ...
    def test_kind_in_allowlist(self):
        from kadhi_cli.utils.adapter_scan import _VALID_KINDS
...
class TestSourceWiring:
    def test_module_imports_clean(self):
        import kadhi_cli.utils.adapter_scan as m
    ...
    def test_no_top_level_torch(self):
        src = (
            ...
            / "src" / "kadhi_cli" / "utils" / "adapter_scan.py"
        )
