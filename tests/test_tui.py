"""Tests for v0.34.0 Part G — kadhi tui."""
...
class TestCli:
    ...
    def test_missing_textual_friendly_error(self, monkeypatch):
        ...
        monkeypatch.setitem(sys.modules, "kadhi_cli.tui_app", None)
        runner = CliRunner()
...
class TestRowBuilders:
    def test_build_runs_table_rows(self):
        from kadhi_cli.tui_app import build_runs_table_rows
    ...
    def test_build_run_detail(self):
        from kadhi_cli.tui_app import build_run_detail
