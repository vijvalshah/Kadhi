...
Extends ``kadhi_cli/utils/diagnose/refusal.py::_REFUSAL_PATTERNS`` from
...
from kadhi_cli.utils.diagnose.refusal import (
    _MAX_LANG_CODE_LEN,
    _MAX_REFUSAL_SCAN,
...
class TestSourceWiring:
    ...
    def test_apply_pattern_is_module_level_function(self) -> None:
        import kadhi_cli.utils.diagnose.refusal as mod
