...
class TestHashing:
    ...
    def test_hash_file_matches_content(self, tmp_path):
        from kadhi_cli.registry.hashing import hash_file
    ...
    def test_hash_entry_combines_config_and_data(self, tmp_path):
        from kadhi_cli.registry.hashing import hash_entry
...
class TestValidation:
    def test_valid_name_accepted(self):
        from kadhi_cli.registry.store import validate_name
    ...
    def test_valid_tag_accepted(self):
        from kadhi_cli.registry.store import validate_tag
...
class TestRegistryStore:
    ...
    def test_resolve_ambiguous_prefix_raises(self, tmp_path):
        ...
        import kadhi_cli.registry.store as store_mod
...
class TestDiff:
    def test_config_diff_detects_changes(self):
        from kadhi_cli.registry.diff import config_diff
    ...
    def test_eval_delta(self):
        from kadhi_cli.registry.diff import eval_delta
...
class TestSecurity:
    ...
    def test_store_resolves_real_path_for_containment(self, tmp_path):
        ...
        from kadhi_cli.registry.store import _is_under
