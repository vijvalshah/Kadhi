...
class TestPublicSurface:
    def test_module_importable(self) -> None:
        from kadhi_cli.utils import adapter_bisect
...
class TestBisectPlan:
    def test_construct(self) -> None:
        from kadhi_cli.utils.adapter_bisect import BisectPlan
    ...
    def test_oversize_history_rejected(self) -> None:
        from kadhi_cli.utils.adapter_bisect import MAX_HISTORY, BisectPlan
...
class TestBisectStep:
    def test_construct(self) -> None:
        from kadhi_cli.utils.adapter_bisect import BisectStep
...
class TestBuildBisectPlan:
    def test_happy(self) -> None:
        from kadhi_cli.utils.adapter_bisect import build_bisect_plan
...
class TestBisectNextStep:
    def test_picks_midpoint(self) -> None:
        from kadhi_cli.utils.adapter_bisect import BisectPlan, bisect_next_step
...
class TestRunBisect:
    def test_finds_first_broken(self) -> None:
        from kadhi_cli.utils.adapter_bisect import BisectPlan, run_bisect
    ...
    def test_non_plan_rejected(self) -> None:
        from kadhi_cli.utils.adapter_bisect import run_bisect
...
class TestSourceWiring:
    def test_no_top_level_heavy_imports(self) -> None:
        ...
        src = (root / "src" / "kadhi_cli" / "utils" / "adapter_bisect.py").read_text(
            encoding="utf-8"
        )
        head_lines = [
            line
