...
class TestTrainingArgumentsPrecisionAsksTheCardToo:
    ...
    cuda>=11.0"* while building TrainingArguments. So **every** `kadhi train`
...
class TestEveryTrainerAsksTheCard:
    ...
    only"), so this SCANS every module in ``kadhi_cli/trainer/`` rather than
    ...
    def _trainer_sources(self):
        ...
        import kadhi_cli.trainer as pkg
