...
def test_module_imports():
    from kadhi_cli.utils import drift_alarm
...
def test_compute_token_distribution_basic():
    from kadhi_cli.utils.drift_alarm import compute_token_distribution
...
def test_drift_report_frozen():
    from kadhi_cli.utils.drift_alarm import DriftReport
...
def test_run_drift_check_happy(tmp_path, monkeypatch):
    from kadhi_cli.utils.drift_alarm import run_drift_check
