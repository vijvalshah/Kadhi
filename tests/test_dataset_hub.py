...
class TestDataSearch:
    """Tests for `kadhi data search` subcommand."""

    @patch("kadhi_cli.commands.data.list_datasets")
...
class TestDataPreview:
    """Tests for `kadhi data preview` subcommand."""

    @patch("kadhi_cli.commands.data._hf_dataset_info")
...
class TestDataDownload:
    """Tests for `kadhi data download` subcommand."""

    @patch("kadhi_cli.commands.data._hf_download_dataset")
...
class TestHelperFunctions:
    ...
    def test_format_size_bytes(self):
        ...
        from kadhi_cli.commands.data import _format_size_bytes
    ...
    def test_format_count(self):
        ...
        from kadhi_cli.commands.data import _format_count
