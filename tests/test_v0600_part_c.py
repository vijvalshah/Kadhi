...
- CLI smoke (``kadhi adapters check-safetensors``)
"""
...
class TestStrictSafetensors:
    ...
    def test_unsafe_extensions_includes_bin_pt(self):
        from kadhi_cli.utils.strict_safetensors import UNSAFE_EXTENSIONS
    ...
    def test_is_safetensors_magic_rejects_invalid_input(self):
        ...
        """
        from kadhi_cli.utils.strict_safetensors import is_safetensors_magic
    ...
    def test_max_safetensors_header_bytes_tightened(self):
        ...
        """
        from kadhi_cli.utils.strict_safetensors import _MAX_SAFETENSORS_HEADER_BYTES
    ...
    def test_find_unsafe_clean(self, tmp_path, monkeypatch):
        ...
        from kadhi_cli.utils.strict_safetensors import find_unsafe_weight_files
...
class TestSourceWiring:
    def test_module_imports(self):
        from kadhi_cli.utils import strict_safetensors as m
