...
class TestAnalyzeDataset:
    ...
    def test_analyze_alpaca_dataset(self, tmp_path):
        from kadhi_cli.autopilot.analyzer import analyze_dataset
...
class TestAnalyzeModel:
    def test_analyze_llama3_8b(self):
        from kadhi_cli.autopilot.analyzer import analyze_model
...
class TestAnalyzeHardware:
    def test_returns_dict_like(self):
        from kadhi_cli.autopilot.analyzer import analyze_hardware
...
class TestDecisionEngine:
    def test_decide_task_chat(self):
        from kadhi_cli.autopilot.decisions import decide_task
    ...
    def test_decide_quantization_plenty(self):
        from kadhi_cli.autopilot.decisions import decide_quantization
    ...
    def test_decide_performance_flags_ampere(self):
        from kadhi_cli.autopilot.decisions import decide_performance_flags
...
class TestBuildConfig:
    ...
    def test_build_kadhi_config(self, tmp_path):
    ...
    def test_write_yaml(self, tmp_path):
        ...
        output_path = tmp_path / "kadhi.yaml"
...
class TestAutopilotCLI:
    ...
    def test_writes_config(self, tmp_path, monkeypatch):
        ...
        assert (tmp_path / "kadhi.yaml").exists()
...
class TestGPUBudgetParsing:
    def test_parse_gb(self):
        from kadhi_cli.autopilot.decisions import parse_gpu_budget
