...
class TestPrepareRewardDataset:
    ...
    def test_from_dpo_format(self):
        from kadhi_cli.trainer.reward_model import _prepare_reward_dataset
...
class TestInitRLHF:
    ...
    def test_init_rlhf_template(self, tmp_path):
        """kadhi init --template rlhf should create a valid config."""
        from typer.testing import CliRunner

        from kadhi_cli.cli import app

        runner = CliRunner()
        output_file = tmp_path / "kadhi_ppo.yaml"
    ...
    def test_init_help_shows_rlhf(self):
        """kadhi init --help should mention rlhf template."""
        from typer.testing import CliRunner
...
class TestTrainCliRegistration:
    ...
    def test_train_help_shows_config(self):
        """kadhi train --help should show --config option."""
        from typer.testing import CliRunner
