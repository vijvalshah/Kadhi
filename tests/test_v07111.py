...
class TestRLSignalBuffer:
    def test_record_and_snapshot(self):
        from kadhi_cli.utils.rl_signal_buffer import RLSignalBuffer
    ...
    def test_wrap_preserves_name_and_captures(self):
        from kadhi_cli.utils.rl_signal_buffer import RLSignalBuffer, wrap_reward_funcs
...
class TestRewardHackCallback:
    def test_build_returns_callback_not_notimplemented(self):
        from kadhi_cli.utils.reward_hacking import (
            RewardHackCallback,
    ...
    def test_compute_separation_from_stats(self):
        from kadhi_cli.utils.reward_hacking import compute_separation_from_stats
...
class TestEchoTrapCallback:
    def test_build_returns_callback_not_notimplemented(self):
        from kadhi_cli.utils.echo_trap import EchoTrapCallback, build_echo_trap_callback
...
class TestRLCheckpointCallback:
    ...
    def test_build_rejects_non_config(self):
        from kadhi_cli.utils.rl_checkpoint import build_rl_checkpoint_callback
...
class TestULD:
    def test_build_returns_projection(self):
        from kadhi_cli.utils.uld import ULDConfig, ULDProjection, build_uld_projection
    ...
    def test_build_rejects_non_config(self):
        from kadhi_cli.utils.uld import build_uld_projection
...
class TestMiniLLM:
    ...
    def test_build_rejects_non_config(self):
        from kadhi_cli.utils.minillm import build_minillm_callback
...
class TestIterativeDPO:
    def test_build_pairs_from_scored(self):
        from kadhi_cli.utils.iterative_dpo import build_pairs_from_scored
    ...
    def test_run_iterative_dpo_with_fakes(self, tmp_path, monkeypatch):
        from kadhi_cli.utils.iterative_dpo import (
            IterativeDPOResult,
    ...
    def test_run_rejects_non_plan(self):
        from kadhi_cli.utils.iterative_dpo import run_iterative_dpo
    ...
    def test_cli_plan_only_still_exits_zero(self, tmp_path, monkeypatch):
        ...
        from kadhi_cli.commands.iterative_dpo import app
    ...
    def test_cli_runs_with_monkeypatched_runner(self, tmp_path, monkeypatch):
        ...
        import kadhi_cli.utils.iterative_dpo as idpo
        from kadhi_cli.commands.iterative_dpo import app
        from kadhi_cli.utils.iterative_dpo import IterativeDPOResult
...
class TestGrpoVariantFallbackWarning:
    def test_fallback_warns_once(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="kadhi_cli.trainer.grpo"):
...
class TestGrpoEmaInPlace:
    def test_in_place_blends_toward_policy(self):
        ...
        from kadhi_cli.monitoring.grpo_stability_callback import update_ema_in_place
    ...
    def test_callback_warns_once_on_zero_overlap(self, caplog):
        ...
        from kadhi_cli.monitoring.grpo_stability_callback import (
...
class TestSourceWiring:
    def _read(self, rel: str) -> str:
        ...
        return (root / "src" / "kadhi_cli" / rel).read_text(encoding="utf-8")
