...
class TestDistillMode:
    def test_supported_modes_frozenset(self):
        from kadhi_cli.utils.distill import SUPPORTED_DISTILL_MODES
    ...
    def test_extract_prompt_messages_strips_trailing_assistant(self):
        from kadhi_cli.utils.distill import extract_prompt_messages
    ...
    def test_trainer_rejects_sequence_plus_uld_or_minillm(self):
        ...
        from kadhi_cli.trainer import distill as distill_trainer
...
class TestBlockExpansionPerArch:
    def test_arch_table_keys(self):
        from kadhi_cli.utils.block_expansion import _ARCH_RESIDUAL_PATHS
    ...
    def test_expand_appends_and_zero_inits(self):
        ...
        from kadhi_cli.utils.block_expansion import expand_model_blocks
...
class TestLongLoRAShift:
    def test_shift_heads_for_s2_preserves_shape(self):
        ...
        from kadhi_cli.utils.longlora import shift_heads_for_s2
    ...
    def test_shift_proj_block_shifts_second_half_heads(self):
        ...
        from kadhi_cli.utils.longlora import _shift_proj_block
    ...
    def test_separate_families(self):
        from kadhi_cli.utils.longlora import _FUSED_QKV_FAMILIES, _SEPARATE_QKV_FAMILIES
    ...
    def test_override_patches_qk_and_restores(self):
        ...
        from kadhi_cli.utils.longlora import LongLoRAForwardOverride
        ...
        assert not getattr(attn.q_proj.forward, "_kadhi_longlora_patched", False)
...
class TestMixtureOfDepths:
    ...
    def test_mod_capacity_floor_and_clamp(self):
        from kadhi_cli.utils.mod import mod_capacity
    ...
    def test_is_mod_supported_arch(self, name, ok):
        from kadhi_cli.utils.mod import is_mod_supported_arch
    ...
    def test_apply_mod_patch_adds_routers(self):
        from kadhi_cli.utils.mod import apply_mod_patch

        model = _make_fake_llama(num_layers=3, hidden=8)
        patched = apply_mod_patch(model, capacity_factor=0.5)
        assert patched == 3
        for layer in model.model.layers:
            assert getattr(layer, "_kadhi_mod_patched", False) is True
            assert hasattr(layer, "_kadhi_mod_router")
...
def _make_bank(dim=8, users=("alice", "bob")):
    from kadhi_cli.utils.vector_bank import BankEntry, VectorBank
...
class TestVectorBankServing:
    def test_reconstruct_projection_deterministic(self):
        ...
        from kadhi_cli.utils.vector_bank import reconstruct_projection
    ...
    def test_apply_bank_to_serve_returns_loaded(self):
        from kadhi_cli.utils.vector_bank import LoadedVectorBank, apply_bank_to_serve
    ...
    def test_set_active_user_contract(self):
        from kadhi_cli.utils.vector_bank import apply_bank_to_serve
    ...
    def test_delta_for_user_math(self):
        ...
        from kadhi_cli.utils.vector_bank import apply_bank_to_serve, reconstruct_projection
    ...
    def test_load_bank_oversize_rejected(self, tmp_path, monkeypatch):
        from kadhi_cli.utils.vector_bank import load_bank
    ...
    def test_serve_flags_and_header(self):
        ...
        from kadhi_cli.commands import serve
...
class TestMoleGatingKernel:
    def test_build_gating_kernel_softmax(self):
        ...
        from kadhi_cli.utils.mole_routing import MoleGatingConfig, build_gating_kernel
    ...
    def test_build_gating_kernel_non_config(self):
        from kadhi_cli.utils.mole_routing import build_gating_kernel
...
class TestMoleTrainer:
    def test_row_to_text(self):
        from kadhi_cli.trainer.mole_routing import _row_to_text
    ...
    def test_prepare_dataset(self):
        from kadhi_cli.trainer.mole_routing import _prepare_mole_dataset
    ...
    def test_make_trainer_class_factory(self):
        from kadhi_cli.trainer.mole_routing import make_mole_trainer_class
    ...
    def test_train_before_setup_raises(self):
        ...
        assert isinstance(cfg, KadhiConfig)
...
class TestPatchInvariants:
    def test_version_bumped(self):
        ...
        assert parts >= (0, 71, 12), kadhi_cli.__version__
    ...
    @pytest.mark.parametrize("module", [
        "kadhi_cli.utils.mole_routing",
        "kadhi_cli.utils.mod",
    ])
    def test_no_top_level_torch_import(self, module):
        src_path = os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
            "src", "kadhi_cli", "utils", module.rsplit(".", 1)[-1] + ".py",
        )
