...
class TestLicenseMatrix:
    ...
    def test_known_licenses_includes_common(self):
        from kadhi_cli.utils.license_matrix import KNOWN_LICENSES
    ...
    def test_matrix_immutable(self):
        from kadhi_cli.utils.license_matrix import LICENSE_MATRIX

        with pytest.raises(TypeError):
            LICENSE_MATRIX["evil"] = ("anything",)  # type: ignore[index]

    def test_normalise_license_id(self):
        from kadhi_cli.utils.license_matrix import normalise_license_id
...
class TestMergeIntegration:
    """Regression: license gate is wired into `kadhi adapters merge`."""
    ...
    def test_merge_override_accepted_with_reason(self, tmp_path, monkeypatch):
        ...
        # out of the real ~/.kadhi during tests.
...
class TestSourceWiring:
    def test_module_imports(self):
        from kadhi_cli.utils import license_matrix as m
