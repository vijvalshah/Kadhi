...
from kadhi_cli.trainer.stream_setup import _distributed_launch, refuse_if_data_parallel
...
@pytest.mark.skipif(
    not os.environ.get("KADHI_TEST_MULTI_GPU"),
    reason="needs >1 real CUDA device; set KADHI_TEST_MULTI_GPU=1 to run",
)
