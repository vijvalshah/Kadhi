"""Tests for vLLM backend in kadhi serve."""
...
class TestVllmDetection:
    ...
    def test_get_vllm_version_installed(self):
        ...
        from kadhi_cli.utils.vllm import get_vllm_version
...
class TestServeBackendFlag:
    ...
    def test_vllm_backend_not_installed(self, tmp_path):
        ...
        with patch("kadhi_cli.utils.vllm.is_vllm_available", return_value=False):
            result = runner.invoke(
    ...
    def test_vllm_hint_shown_when_available(self, tmp_path):
        ...
        from kadhi_cli.commands import serve as serve_mod
        ...
        try:
            with patch("kadhi_cli.utils.vllm.is_vllm_available", return_value=True):
...
class TestServeCliRegistration:
    ...
    def test_serve_help_shows_backend(self):
        """kadhi serve --help should mention --backend flag."""
        from typer.testing import CliRunner
    ...
    def test_serve_help_shows_tensor_parallel(self):
        """kadhi serve --help should mention --tensor-parallel flag."""
        from typer.testing import CliRunner
    ...
    def test_serve_help_shows_gpu_memory(self):
        """kadhi serve --help should mention --gpu-memory flag."""
        from typer.testing import CliRunner
