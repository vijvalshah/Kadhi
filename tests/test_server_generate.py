...
class TestServerProviderValidation:
    """Test that 'server' is a valid provider for kadhi data generate."""
...
class TestGenerateServer:
    ...
    def test_generate_server_calls_httpx(self):
        ...
        from kadhi_cli.commands.generate import _generate_server
...
class TestGenerateBatchRouting:
    ...
    def test_batch_routes_to_openai(self):
        ...
        with mock_patch(
            "kadhi_cli.commands.generate._generate_openai",
            return_value=[],
        ) as mock_openai:
            _generate_batch(
                prompt="test",
    ...
    def test_batch_routes_to_local(self):
        ...
        with mock_patch(
            "kadhi_cli.commands.generate._generate_local",
            return_value=[],
        ) as mock_local:
            _generate_batch(
                prompt="test",
...
class TestParseJsonArray:
    ...
    def test_parse_valid_json_array(self):
        ...
        from kadhi_cli.commands.generate import _parse_json_array
...
class TestValidateExample:
    ...
    def test_validate_alpaca_valid(self):
        from kadhi_cli.commands.generate import _validate_example
