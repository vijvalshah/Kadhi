...
class TestValidateStudentIdParity:
    def test_oversize_rejected(self) -> None:
        from kadhi_cli.utils.prompt_distill import validate_student_id
...
class TestEvalSuitePathSymlink:
    def test_symlink_rejected(
        ...
        from kadhi_cli.utils.prompt_compile import validate_eval_suite_path
...
class TestValidateToolOptimizerExtras:
    def test_empty_rejected(self) -> None:
        from kadhi_cli.utils.compile_tools import validate_tool_optimizer
...
class TestValidateDirectionExtras:
    def test_non_string_rejected(self) -> None:
        from kadhi_cli.utils.apple_adapter import validate_direction
...
class TestBuildAppleAdapterPlan:
    def test_happy(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        from kadhi_cli.utils.apple_adapter import build_apple_adapter_plan
...
class TestAppleAdapterOutputDirValidation:
    def test_empty_rejected(
        ...
        from kadhi_cli.utils.apple_adapter import AppleAdapterPlan
...
class TestPartEValidatorParity:
    def test_backend_null_byte_rejected(self) -> None:
        from kadhi_cli.utils.local_rl import validate_local_rl_backend
    ...
    def test_train_method_null_byte_rejected(self) -> None:
        from kadhi_cli.utils.local_rl import validate_local_rl_train_method
...
class TestTrainMethodAllowlistImmutability:
    def test_immutable(self) -> None:
        from kadhi_cli.utils.local_rl import SUPPORTED_LOCAL_RL_TRAIN_METHODS
...
class TestValidateDbPathPublic:
    def test_importable(self) -> None:
        from kadhi_cli.utils.local_rl import validate_db_path  # noqa: F401

    def test_in_all(self) -> None:
        from kadhi_cli.utils import local_rl
...
class TestHarvestMissingFile:
    def test_missing_db_raises(
        ...
        from kadhi_cli.utils.local_rl import harvest_dpo_pairs
