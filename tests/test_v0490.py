...
class TestYarnMath:
    def test_yarn_find_correction_dim(self):
        from kadhi_cli.utils.long_context import yarn_find_correction_dim
    ...
    def test_yarn_find_correction_range_ordered(self):
        from kadhi_cli.utils.long_context import yarn_find_correction_range
    ...
    def test_yarn_linear_ramp_mask_shape_and_bounds(self):
        from kadhi_cli.utils.long_context import yarn_linear_ramp_mask
    ...
    def test_yarn_get_attn_scale(self):
        from kadhi_cli.utils.long_context import yarn_get_mscale
...
class TestLongLoraHelpers:
    def test_is_llama_model_word_boundary(self):
        from kadhi_cli.utils.longlora import is_llama_model
...
"""
    ...
    def test_llama3_constants_present(self):
        from kadhi_cli.utils.long_context import (
...
class TestLlama3InvFreqScale:
    def test_low_freq_passthrough(self):
        ...
        from kadhi_cli.utils.long_context import scale_inv_freq_llama3
    ...
    def test_auto_detect_llama3_from_config(self):
        ...
        from kadhi_cli.utils.long_context import detect_llama3_rope_in_config
