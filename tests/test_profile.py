"""Tests for kadhi profile command — memory/speed estimator."""
...
class TestEstimateModelMemory:
    ...
    def test_7b_4bit(self):
        from kadhi_cli.utils.profiler import estimate_model_memory
...
class TestEstimateLoraMemory:
    ...
    def test_default_lora(self):
        from kadhi_cli.utils.profiler import estimate_lora_memory
...
class TestEstimateOptimizerMemory:
    ...
    def test_adam_optimizer(self):
        from kadhi_cli.utils.profiler import estimate_optimizer_memory
...
class TestEstimateActivationMemory:
    ...
    def test_basic(self):
        from kadhi_cli.utils.profiler import estimate_activation_memory
...
class TestEstimateTotal:
    """Test total profile estimation from KadhiConfig."""

    def test_basic_profile(self):
        from kadhi_cli.utils.profiler import estimate_total
...
class TestEstimateSpeed:
    ...
    def test_basic_speed(self):
        from kadhi_cli.utils.profiler import estimate_speed
...
class TestEstimateTrainingTime:
    ...
    def test_basic_time(self):
        from kadhi_cli.utils.profiler import estimate_training_time
...
class TestRecommendBatchSize:
    ...
    def test_basic_recommendation(self):
        from kadhi_cli.utils.profiler import recommend_batch_size
...
class TestRecommendGpu:
    ...
    def test_small_model(self):
        from kadhi_cli.utils.profiler import recommend_gpu
...
class TestModelArchLookup:
    ...
    def test_known_model_8b(self):
        from kadhi_cli.utils.profiler import get_model_arch
...
class TestProfileCLI:
    ...
    def test_profile_with_config_file(self, tmp_path):
        """kadhi profile --config kadhi.yaml shows profile panel."""
    ...
    def test_profile_json_output(self, tmp_path):
        """kadhi profile --json outputs valid JSON."""
        config_file = tmp_path / "kadhi.yaml"
        config_file.write_text(
            "base: meta-llama/Llama-3.1-8B-Instruct\n"
            "task: sft\n"
    ...
    def test_profile_with_gpu_flag(self, tmp_path):
        """kadhi profile --gpu a100 uses specified GPU memory."""
        config_file = tmp_path / "kadhi.yaml"
        config_file.write_text(
            "base: meta-llama/Llama-3.1-8B-Instruct\n"
            "task: sft\n"
    ...
    def test_profile_missing_config(self):
        """kadhi profile --config nonexistent.yaml fails gracefully."""
...
class TestGpuLookup:
    ...
    def test_known_gpus(self):
        from kadhi_cli.utils.profiler import GPU_MEMORY
...
class TestResolveGpuMemory:
    ...
    def test_fallback_to_default_24gb(self, monkeypatch):
        from kadhi_cli.commands.profile import _resolve_gpu_memory
...
class TestTrainableParamsEstimate:
    ...
    def test_lora_params(self):
        from kadhi_cli.utils.profiler import estimate_trainable_params
