...
the actual round-orchestrator (which would invoke `kadhi train --task dpo`
...
class TestIterativeDPOPublicSurface:
    def test_module_imports(self):
        from kadhi_cli.utils import iterative_dpo
...
class TestValidateRounds:
    def test_happy(self):
        from kadhi_cli.utils.iterative_dpo import validate_rounds
...
class TestValidatePairsPerRound:
    def test_happy(self):
        from kadhi_cli.utils.iterative_dpo import validate_pairs_per_round
...
class TestIterativeDPORound:
    def test_basic(self):
        from kadhi_cli.utils.iterative_dpo import IterativeDPORound
...
class TestIterativeDPOPlan:
    ...
    def test_zero_rounds_rejected(self):
        from kadhi_cli.utils.iterative_dpo import IterativeDPOPlan
...
class TestBuildIterativeDPOPlan:
    def test_happy(self, tmp_path, monkeypatch):
        from kadhi_cli.utils.iterative_dpo import build_iterative_dpo_plan
...
class TestSourceWiring:
    ...
    def test_cli_registered(self):
        """kadhi iterative-dpo command registered on the top-level Typer app."""
        from pathlib import Path
