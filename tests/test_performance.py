...
from kadhi_cli.config.schema import TEMPLATES, KadhiConfig

# ─── Liger Kernel Tests ─────────────────────────────────────────────────


class TestLigerConfig:
    """Test Liger Kernel configuration in KadhiConfig."""

    def test_use_liger_default_false(self):
        cfg = KadhiConfig(base="test/model", data={"train": "./data.jsonl"})
...
class TestLigerValidation:
    ...
    def test_validate_liger_not_installed(self):
        ...
        with patch("kadhi_cli.utils.liger.check_liger_available", return_value=False):
    ...
    def test_validate_liger_valid_config(self):
        ...
        with patch("kadhi_cli.utils.liger.check_liger_available", return_value=True):
            errors = validate_liger_config(True, "transformers", "cuda")
            assert errors == []
...
class TestLigerDetection:
    ...
    def test_check_liger_available_not_installed(self):
        from kadhi_cli.utils.liger import check_liger_available
    ...
    def test_get_liger_version_not_installed(self):
        from kadhi_cli.utils.liger import get_liger_version
    ...
    def test_apply_liger_kernel_not_available(self):
        from kadhi_cli.utils.liger import apply_liger_kernel
    ...
    def test_apply_liger_manual_unknown_model(self):
        from kadhi_cli.utils.liger import _apply_liger_manual
...
class TestFlashAttnConfig:
    """Test FlashAttention configuration in KadhiConfig."""
...
class TestFlashAttnDetection:
    ...
    def test_check_flash_attn_available_no_cuda(self):
        with patch("kadhi_cli.utils.flash_attn.check_flash_attn_available") as mock_detect:
            mock_detect.return_value = None
            result = mock_detect()
            assert result is None

    def test_get_attn_implementation_disabled(self):
        from kadhi_cli.utils.flash_attn import get_attn_implementation
    ...
    def test_get_flash_attn_version_not_installed(self):
        from kadhi_cli.utils.flash_attn import get_flash_attn_version

        result = get_flash_attn_version()
        assert result is None or isinstance(result, str)

    def test_flash_attn_versions_constant(self):
        from kadhi_cli.utils.flash_attn import FLASH_ATTN_VERSIONS
...
class TestFSDPConfig:
    ...
    def test_fsdp_full_shard_preset(self):
        from kadhi_cli.utils.fsdp import get_fsdp_config
    ...
    def test_fsdp_training_args_keys(self):
        from kadhi_cli.utils.fsdp import get_fsdp_training_args
    ...
    def test_fsdp_configs_dict(self):
        from kadhi_cli.utils.fsdp import FSDP_CONFIGS
...
class TestFSDPAvailability:
    ...
    def test_is_fsdp_available_returns_bool(self):
        from kadhi_cli.utils.fsdp import is_fsdp_available
...
class TestRingAttentionUtils:
    ...
    def test_get_sequence_parallel_size_single_gpu(self):
        from kadhi_cli.utils.ring_attention import get_sequence_parallel_size
...
class TestRingAttentionValidation:
    ...
    def test_check_ring_attention_available_returns_bool(self):
        from kadhi_cli.utils.ring_attention import check_ring_attention_available

        result = check_ring_attention_available()
        assert isinstance(result, bool)

    def test_get_ring_attention_version_not_installed(self):
        from kadhi_cli.utils.ring_attention import get_ring_attention_version
...
class TestLongContextConfig:
    """Test long-context configuration in KadhiConfig."""
...
class TestLongContextUtils:
    ...
    def test_rope_scaling_types_constant(self):
        from kadhi_cli.utils.long_context import ROPE_SCALING_TYPES
    ...
    def test_model_default_context_llama3(self):
        from kadhi_cli.utils.long_context import get_model_default_context
    ...
    def test_get_rope_scaling_config_linear(self):
        from kadhi_cli.utils.long_context import get_rope_scaling_config
...
class TestTrainerFSDPParam:
    ...
    def test_dpo_trainer_accepts_fsdp_config(self):
        ...
        cfg = KadhiConfig(base="test/model", task="dpo", data={"train": "./data.jsonl"})
    ...
    def test_grpo_trainer_accepts_fsdp_config(self):
        ...
        cfg = KadhiConfig(base="test/model", task="grpo", data={"train": "./data.jsonl"})
    ...
    def test_kto_trainer_accepts_fsdp_config(self):
        ...
        cfg = KadhiConfig(base="test/model", task="kto", data={"train": "./data.jsonl"})
    ...
    def test_orpo_trainer_accepts_fsdp_config(self):
        ...
        cfg = KadhiConfig(base="test/model", task="orpo", data={"train": "./data.jsonl"})
    ...
    def test_simpo_trainer_accepts_fsdp_config(self):
        ...
        cfg = KadhiConfig(base="test/model", task="simpo", data={"train": "./data.jsonl"})
    ...
    def test_ipo_trainer_accepts_fsdp_config(self):
        ...
        cfg = KadhiConfig(base="test/model", task="ipo", data={"train": "./data.jsonl"})
    ...
    def test_ppo_trainer_accepts_fsdp_config(self):
        ...
        cfg = KadhiConfig(base="test/model", task="ppo", data={"train": "./data.jsonl"})
...
class TestTrainCommandFSDPFlag:
    ...
    def test_fsdp_full_shard_has_correct_keys(self):
        from kadhi_cli.utils.fsdp import FSDP_FULL_SHARD
