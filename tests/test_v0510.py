...
from kadhi_cli.config.schema import TEMPLATES, KadhiConfig, TrainingConfig
from kadhi_cli.recipes.catalog import RECIPES, get_recipe, list_recipes, search_recipes
from kadhi_cli.utils import hubs as hubs_mod
from kadhi_cli.utils.hubs import (
    SUPPORTED_HUBS,
    default_endpoint,
    endpoint_env_var,
    is_hf,
...
class TestV0510Recipes:
    ...
    @pytest.mark.parametrize("name", V0510_RECIPE_NAMES)
    def test_recipe_yaml_parses_as_kadhi_config(self, name: str) -> None:
