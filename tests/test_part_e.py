...
Covers:
  ...
  - #57 KadhiTrainerCallback._write_spike_recovery_hint — writes JSON hint
  ...
  - #59 KadhiTrainerCallback grad-accum advisory — fires once on threshold
    crossing.
"""
