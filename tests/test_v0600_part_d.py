...
class TestNamespacePin:
    ...
    def test_pin_frozen(self):
        from kadhi_cli.utils.namespace_pin import NamespacePin
...
class TestSecurityReviewFixes:
    ...
    def test_iso_compare_uses_datetime_parser(self, tmp_path):
        ...
        parser catches it.
        """
        from kadhi_cli.utils.namespace_pin import _is_backward
...
class TestSourceWiring:
    def test_module_imports(self):
        from kadhi_cli.utils import namespace_pin as m
    ...
    def test_no_top_level_torch(self):
        src = (
            ...
            / "src" / "kadhi_cli" / "utils" / "namespace_pin.py"
        )
