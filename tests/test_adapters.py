"""Tests for kadhi adapters — adapter management command."""
...
class TestAdaptersList:
    """Test kadhi adapters list command."""
...
class TestAdaptersInfo:
    """Test kadhi adapters info command."""
...
class TestAdaptersCompare:
    """Test kadhi adapters compare command."""
...
class TestAdapterDiscovery:
    ...
    def test_find_adapters_recursive(self, tmp_path):
        from kadhi_cli.commands.adapters import _find_adapters
    ...
    def test_read_adapter_config(self, tmp_path):
        from kadhi_cli.commands.adapters import _read_adapter_config
