"""Tests for `resolve_transform` in `kadhi_cli.utils.build_dag`.
...
class TestResolveTransformBuiltins:
    ...
    def test_identity(self):
        from kadhi_cli.utils.build_dag import BUILTIN_TRANSFORMS, resolve_transform
    ...
    def test_unknown_raises_value_error(self):
        from kadhi_cli.utils.build_dag import resolve_transform
...
class TestResolveTransformExtraPrecedence:
    ...
    def test_extra_shadows_dotted_path(self):
        ...
        mod_name = _make_transform_module(
            "_kadhi_test_mod_shadow", "my_transform", arity=2, kind="callable"
        )
...
class TestResolveTransformDottedPath:
    ...
    def test_happy_path(self):
        ...
        mod_name = _make_transform_module(
            "_kadhi_test_mod_hp", "my_transform", arity=2, kind="callable"
        )
    ...
    def test_nested_module_path(self):
        ...
        mod_name = _make_transform_module(
            "_kadhi_test_mod_nested", "nested_fn", arity=2, kind="callable"
        )
    ...
    def test_lru_cache_serves_same_result(self):
        ...
        mod_name = _make_transform_module(
            "_kadhi_test_mod_cache", "cached_fn", arity=2, kind="callable"
        )
...
class TestResolveTransformDottedPathErrors:
    ...
    def test_non_callable_attribute(self):
        ...
        mod_name = _make_transform_module(
            "_kadhi_test_mod_noncall", "not_a_fn", arity=2, kind="non_callable"
        )
    ...
    def test_wrong_arity_one_arg(self):
        ...
        mod_name = _make_transform_module(
            "_kadhi_test_mod_arity1", "one_arg", arity=2, kind="partial"
        )
    ...
    def test_wrong_arity_three_args(self):
        ...
        mod_name = _make_transform_module(
            "_kadhi_test_mod_arity3", "three_args", arity=2, kind="three_args"
        )
        with pytest.raises(ValueError, match="exactly 2 positional arguments"):
    ...
    def test_missing_attribute(self):
        ...
        mod_name = _make_transform_module(
            "_kadhi_test_mod_missing", "exists_fn", arity=2, kind="callable"
        )
...
class TestResolveTransformExtraShadowsManifest:
    ...
    def test_extra_overrides_dotted_path(self):
        ...
        mod_name = _make_transform_module(
            "_kadhi_test_mod_override", "manifest_fn", arity=2, kind="callable"
        )
