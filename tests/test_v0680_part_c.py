"""v0.68.0 Part C — ``kadhi compile-tools``.
...
class TestPublicSurface:
    def test_module_importable(self) -> None:
        from kadhi_cli.utils import compile_tools
...
class TestAllowlist:
    def test_frozenset(self) -> None:
        from kadhi_cli.utils.compile_tools import SUPPORTED_TOOL_OPTIMIZERS
...
class TestToolCompilePlan:
    def test_frozen(
        ...
        from kadhi_cli.utils.compile_tools import ToolCompilePlan
...
class TestRunToolCompileDeferred:
    def test_live_missing_dep_importerror(
        ...
        from kadhi_cli.utils.compile_tools import (
