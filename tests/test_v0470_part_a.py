...
def test_module_imports():
    from kadhi_cli.utils import data_forge  # noqa: F401
...
def test_forge_task_literal_constants():
    from kadhi_cli.utils.data_forge import VALID_TASKS
...
def test_forge_plan_frozen():
    ...
    from kadhi_cli.utils.data_forge import ForgePlan
...
def test_provenance_record_frozen():
    ...
    from kadhi_cli.utils.data_forge import ProvenanceRecord
...
def test_forge_row_to_dict_includes_provenance():
    from kadhi_cli.utils.data_forge import ForgeRow, ProvenanceRecord
...
def test_chunk_document_basic():
    from kadhi_cli.utils.data_forge import chunk_document
...
def test_chunk_document_respects_oversize_cap():
    from kadhi_cli.utils.data_forge import _MAX_DOC_CHARS, chunk_document
...
def test_score_uncertainty_bounds():
    from kadhi_cli.utils.data_forge import score_uncertainty
...
def test_build_forge_plan_happy(tmp_path):
    from kadhi_cli.utils.data_forge import build_forge_plan
...
def test_build_forge_plan_target_rows_cap(tmp_path):
    from kadhi_cli.utils.data_forge import _MAX_TARGET_ROWS, build_forge_plan
...
def test_discover_documents_outside_cwd_rejected(tmp_path):
    from kadhi_cli.utils.data_forge import discover_documents
...
def test_write_forge_dataset_rejects_non_forge_row(tmp_path):
    from kadhi_cli.utils.data_forge import write_forge_dataset
...
def test_discover_documents_cap(tmp_path):
    from kadhi_cli.utils.data_forge import _MAX_DOCS
...
def test_synthesise_forge_rows_basic(tmp_path):
    from kadhi_cli.utils.data_forge import synthesise_forge_rows
...
def test_write_forge_dataset_atomic(tmp_path):
    from kadhi_cli.utils.data_forge import (
        ForgeRow,
        ProvenanceRecord,
        write_forge_dataset,
    )
...
def test_write_provenance_outside_cwd_rejected(tmp_path):
    from kadhi_cli.utils.data_forge import write_provenance
