...
def test_module_imports():
    from kadhi_cli.utils import data_score  # noqa: F401
...
def test_benchmarks_immutable():
    ...
    from kadhi_cli.utils.data_score import BENCHMARKS
...
def test_score_report_frozen():
    ...
    from kadhi_cli.utils.data_score import ScoreReport
...
def test_ngram_set_basic():
    from kadhi_cli.utils.data_score import ngram_set
...
def test_ngram_set_oversize_rejected():
    from kadhi_cli.utils.data_score import _MAX_TEXT_CHARS, ngram_set
...
def test_ngram_overlap_ratio_identical_is_one():
    from kadhi_cli.utils.data_score import ngram_overlap_ratio
...
def test_decontaminate_rows_removes_overlap():
    from kadhi_cli.utils.data_score import decontaminate_rows
...
def test_detect_pii_email():
    from kadhi_cli.utils.data_score import detect_pii
...
def test_detect_pii_caps_text_size():
    from kadhi_cli.utils.data_score import _MAX_TEXT_CHARS, detect_pii
...
def test_detect_language_english_heuristic():
    from kadhi_cli.utils.data_score import detect_language
...
def test_score_educational_value_bounds():
    from kadhi_cli.utils.data_score import score_educational_value
...
def test_load_jsonl_rows_cap(tmp_path):
    from kadhi_cli.utils.data_score import _MAX_ROWS
...
# ---------------------------------------------------------------------------
# CLI: kadhi data score, decontaminate, toxicity, langdetect, pii, educational
# ---------------------------------------------------------------------------
