"""v0.71.29 — `kadhi shrink`: depth-prune + distill-heal (arXiv:2403.17887).
...
from kadhi_cli.utils.shrink import (
    DECISION_DONT_SHIP,
    DECISION_SHIP,
    LayerImportance,
    decide_shrink,
...
class TestDecideShrink:
    ...
    def test_to_dict_roundtrip(self):
        ...
        assert set(d) >= {
            ...
            "layers_before", "layers_after", "params_saved_pct", "healed", "kadhi_version",
        }
...
class TestNoTopLevelTorch:
    def test_shrink_module_has_no_top_level_heavy_import(self):
        import kadhi_cli.utils.shrink as _mod
...
class TestPrune:
    def test_arch_detected(self):
        from kadhi_cli.utils.shrink import shrink_arch_of
    ...
    def test_prune_removes_block_and_patches_config(self):
        from kadhi_cli.utils.shrink import prune_model_layers
    ...
    def test_layer_list_arch_guarded(self):
        from kadhi_cli.utils.shrink import layer_list
...
class TestImportance:
    def test_off_by_one_boundary_indices(self):
        ...
        from kadhi_cli.utils import shrink
    ...
    def test_select_drop_block_min(self):
        from kadhi_cli.utils.shrink import LayerImportance, select_drop_block
    ...
    def test_select_drop_block_empty_raises(self):
        from kadhi_cli.utils.shrink import select_drop_block

        with pytest.raises(ValueError):
            select_drop_block([])

    def test_resolve_drop_count_ratio(self):
        from kadhi_cli.utils.shrink import resolve_drop_count
...
class TestHeal:
    def test_build_heal_config_parses(self):
        from kadhi_cli.commands.shrink import _build_heal_config_yaml
    ...
    def test_heal_path_sets_healed(self, tmp_path, monkeypatch):
        ...
        from kadhi_cli.cli import app
        from kadhi_cli.commands import shrink as shrink_cmd
...
class TestRegistryAttach:
    def test_attach_round_trip(self, tmp_path, monkeypatch):
        ...
        from kadhi_cli.commands.shrink import _attach_to_registry
    ...
    def test_attach_unknown_entry_warns_no_raise(self, tmp_path, monkeypatch):
        monkeypatch.setenv("KADHI_REGISTRY_DB_PATH", str(tmp_path / "reg2.db"))
        monkeypatch.chdir(tmp_path)
...
class TestReviewFixes:
    ...
    def test_perplexity_no_top_level_math_import_uses_isnan(self):
        ...
        import kadhi_cli.commands.shrink as _mod
    ...
    def test_fuse_adapter_produces_dense_model(self, tmp_path, monkeypatch):
        ...
        from kadhi_cli.commands.shrink import _fuse_adapter
...
class TestRunHeal:
    def test_success_calls_fuse_with_right_dirs(self, tmp_path, monkeypatch):
        import kadhi_cli.commands.shrink as sc
    ...
    def test_timeout_raises(self, tmp_path, monkeypatch):
        ...
        def _boom(*a, **k):
            raise _sp.TimeoutExpired(cmd="kadhi train", timeout=1)
...
class TestDropCountEdges:
    ...
    def test_max_count_agrees_across_three_functions(self):
        from kadhi_cli.utils.shrink import prune_model_layers, resolve_drop_count
...
class TestArchQwen:
    def test_qwen_detected(self):
        from kadhi_cli.utils.shrink import arch_family_of_config
...
class TestExtractText:
    def test_plain_string(self):
        from kadhi_cli.commands.shrink import _extract_text
...
class TestLoadCalibEdges:
    def _run(self, tmp_path, monkeypatch, content):
        ...
        from kadhi_cli.commands.shrink import _load_calib
    ...
    def test_row_cap_truncates(self, tmp_path, monkeypatch):
        from kadhi_cli.commands import shrink as sc
...
class TestPerplexityInf:
    def test_returns_inf_when_all_single_token(self):
        ...
        from kadhi_cli.commands.shrink import _perplexity
...
class TestImportanceCaps:
    ...
    def test_mask_none_branch(self):
        from kadhi_cli.utils.shrink import compute_layer_importance
...
class TestDecideShrinkBoundaries:
    def test_just_past_tolerance_dont_ship(self):
        from kadhi_cli.utils.shrink import DECISION_DONT_SHIP, decide_shrink
    ...
    def test_match_keywords_on_validation(self):
        from kadhi_cli.utils.shrink import decide_shrink
