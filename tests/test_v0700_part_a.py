...
class TestRewardHackingPublicSurface:
    def test_module_imports(self):
        from kadhi_cli.utils import reward_hacking
    ...
    def test_supported_detectors_is_frozenset(self):
        from kadhi_cli.utils.reward_hacking import SUPPORTED_HACK_DETECTORS
...
class TestValidateHackDetector:
    def test_happy_path(self):
        from kadhi_cli.utils.reward_hacking import validate_hack_detector
...
class TestComputeClusterSeparation:
    ...
    def test_perfect_separation(self):
        from kadhi_cli.utils.reward_hacking import compute_cluster_separation
...
class TestComputeRmEnsembleDivergence:
    ...
    def test_perfect_agreement(self):
        from kadhi_cli.utils.reward_hacking import compute_rm_ensemble_divergence
...
class TestRewardHackReport:
    def test_basic_construction(self):
        from kadhi_cli.utils.reward_hacking import RewardHackReport
...
# ---------------------------------------------------------------------------
# Schema integration — TrainingConfig + KadhiConfig
# ---------------------------------------------------------------------------
...
class TestSchemaKadhiConfigTaskGate:
...
class TestSourceWiring:
    ...
    def test_version_bumped(self):
        ...
        major_minor = tuple(int(x) for x in kadhi_cli.__version__.split(".")[:2])
        # 0.70 floor.
