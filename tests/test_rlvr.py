...
class TestCodeExecReward:
    def test_correct_code(self):
        from kadhi_cli.trainer.rewards import code_exec_reward
    ...
    def test_output_size_capped(self):
        ...
        from kadhi_cli.trainer.rewards import MAX_CODE_OUTPUT_BYTES, code_exec_reward
...
class TestJsonSchemaReward:
    def test_valid_matching_schema(self):
        from kadhi_cli.trainer.rewards import json_schema_reward
...
class TestVerifiableTemplate:
    def test_build_prompt_math(self):
        from kadhi_cli.data.templates.verifiable import build_prompt
    ...
    def test_domains_constant(self):
        from kadhi_cli.data.templates.verifiable import TEMPLATE_SPEC
