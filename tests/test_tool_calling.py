...
class TestToolCallingTemplate:
    def test_build_prompt_contains_domains_and_count(self):
        from kadhi_cli.data.templates.tool_calling import build_prompt
    ...
    def test_available_domains(self):
        from kadhi_cli.data.templates.tool_calling import TEMPLATE_SPEC
...
class TestToolCallingConfig:
    ...
    def test_kadhiconfig_tool_calling(self):
...
class TestToolCallingInitTemplate:
    ...
    def test_init_with_tool_calling_template(self, tmp_path, monkeypatch):
        ...
        kadhi_yaml = tmp_path / "kadhi.yaml"
        assert kadhi_yaml.exists()
        content = kadhi_yaml.read_text(encoding="utf-8")
...
class TestToolCallScoring:
    ...
    def test_tool_call_match_exact(self):
        from kadhi_cli.eval.custom import tool_call_match
    ...
    def test_tool_call_args_subset_partial(self):
        from kadhi_cli.eval.custom import tool_call_args_subset
    ...
    def test_tool_call_scoring_registered(self):
        ...
        from kadhi_cli.eval.custom import VALID_SCORING
