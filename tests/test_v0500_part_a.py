...
from kadhi_cli.utils import grpo_variants
from kadhi_cli.utils.grpo_variants import (
...
def test_kadhiconfig_grpo_variant_happy():
...
def test_kadhiconfig_grpo_variant_rejected_on_non_grpo_task():
    yaml = """
base: test-llama
task: sft
data:
...
def test_kadhiconfig_two_sided_with_delta_happy():
...
def test_kadhiconfig_mlx_backend_rejected():
    yaml = """
base: test-llama
task: grpo
backend: mlx
