...
class TestEmbeddingSweepParams:
    ...
    def test_sweep_run_single_routes_to_embedding_trainer(self):
        ...
        with mock_patch("kadhi_cli.data.loader.load_dataset", return_value=fake_dataset), \
             ...
             mock_patch("kadhi_cli.trainer.embedding.EmbeddingTrainerWrapper.setup"), \
             mock_patch(
                 "kadhi_cli.trainer.embedding.EmbeddingTrainerWrapper.train",
...
class TestEmbeddingTrainResults:
    ...
    def test_train_result_duration_minutes_format(self):
        ...
        with mock_patch("kadhi_cli.trainer.embedding.time.time", side_effect=fake_time):
            result = wrapper.train()
...
class TestEmbeddingInitTemplate:
    """Test that kadhi init produces correct output for embedding."""

    def test_init_embedding_template_creates_file(self, tmp_path):
        """kadhi init --template embedding should write a file with embedding task."""
    ...
    def test_init_embedding_template_produces_valid_config(self, tmp_path):
        """The file written by kadhi init --template embedding should parse."""
...
class TestPoolingFunction:
    ...
    def test_mean_pooling(self):
        ...
        from kadhi_cli.trainer.embedding import _pool_embeddings
