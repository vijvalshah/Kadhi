...
from kadhi_cli.utils.prm import (
    build_prm_trainer,
    validate_prm_compat,
...
def test_vision_grpo_kadhiconfig_ppo_happy():
    """tdd-guide MEDIUM fix: confirm ppo path is wired at KadhiConfig level.
...
def test_vision_grpo_kadhiconfig_happy():
