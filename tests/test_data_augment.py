...
class TestAugmentStrategies:
    def test_rephrase_basic(self):
        from kadhi_cli.data.augment import augment_rephrase
    ...
    def test_translate_produces_langs(self):
        from kadhi_cli.data.augment import augment_translate
    ...
    def test_style_produces_styles(self):
        from kadhi_cli.data.augment import augment_style
    ...
    def test_empty_examples_returns_empty(self):
        from kadhi_cli.data.augment import (
            augment_rephrase,
            augment_style,
            augment_translate,
        )
