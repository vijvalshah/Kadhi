...
class TestTTSUtils:
    def test_supported_families_frozenset(self):
        from kadhi_cli.utils.tts import SUPPORTED_TTS_FAMILIES
    ...
    def test_validate_family_canonical(self, name):
        from kadhi_cli.utils.tts import validate_tts_family
    ...
    def test_family_metadata_frozen(self):
        from kadhi_cli.utils.tts import get_tts_family_spec
    ...
    def test_supports_emotion(self):
        from kadhi_cli.utils.tts import family_supports_emotion
    ...
    def test_emotion_tag_orpheus_happy(self):
        from kadhi_cli.utils.tts import validate_emotion_tag
    ...
    def test_validate_tts_compat_happy(self):
        from kadhi_cli.utils.tts import validate_tts_compat
    ...
    def test_build_tts_trainer_lifted_v07120(self):
        ...
        from kadhi_cli.utils.tts import build_tts_trainer
...
class TestClassifierUtils:
    def test_classifier_tasks_frozenset(self):
        from kadhi_cli.utils.classifier import CLASSIFIER_TASKS
    ...
    def test_is_classifier_task_true(self, task):
        from kadhi_cli.utils.classifier import is_classifier_task
    ...
    def test_get_classifier_spec_paired_input(self):
        from kadhi_cli.utils.classifier import get_classifier_spec
    ...
    def test_validate_classifier_compat_mlx_reject(self):
        from kadhi_cli.utils.classifier import validate_classifier_compat
    ...
    def test_build_classifier_trainer_lifted_in_v0532(self):
        ...
        from kadhi_cli.utils.classifier import build_classifier_trainer
...
class TestDistillUtils:
    ...
    def test_get_divergence_spec_symmetric(self):
        from kadhi_cli.utils.distill import get_divergence_spec
    ...
    def test_build_distill_trainer_lifted_in_v0532(self):
        ...
        now raises TypeError (missing ``config``) rather than NotImplementedError."""
        from kadhi_cli.utils.distill import build_distill_trainer
...
class TestBitNetUtils:
    def test_bitnet_quant_formats_frozenset(self):
        from kadhi_cli.utils.bitnet import BITNET_EXPORT_FORMATS, BITNET_QUANT_FORMATS
    ...
    def test_is_bitnet_quant(self, value, expected):
        from kadhi_cli.utils.bitnet import is_bitnet_quant

        assert is_bitnet_quant(value) is expected

    def test_get_bitnet_spec(self):
        from kadhi_cli.utils.bitnet import get_bitnet_spec
    ...
    def test_is_bitnet_model(self, name, expected):
        from kadhi_cli.utils.bitnet import is_bitnet_model
    ...
    def test_validate_bitnet_export_canonical(self):
        from kadhi_cli.utils.bitnet import validate_bitnet_export
    ...
    def test_build_bitnet_trainer_lifted_v07120(self):
        ...
        from kadhi_cli.utils.bitnet import build_bitnet_trainer
    ...
    def test_export_bitnet_gguf_lifted_v07120(self):
        ...
        from kadhi_cli.utils.bitnet import export_bitnet_gguf
...
class TestEbftGdpoUtils:
    def test_ebft_variants(self):
        from kadhi_cli.utils.ebft_gdpo import EBFT_VARIANTS, validate_ebft_variant
    ...
    def test_gdpo_variants(self):
        from kadhi_cli.utils.ebft_gdpo import GDPO_VARIANTS, validate_gdpo_variant
    ...
    def test_validate_ebft_variant_rejects(self, bad, exc):
        from kadhi_cli.utils.ebft_gdpo import validate_ebft_variant
    ...
    def test_get_ebft_spec(self):
        ...
        from kadhi_cli.utils.ebft_gdpo import get_ebft_spec, get_gdpo_spec
    ...
    def test_apply_ebft_loss_lifted_in_v0532(self):
        ...
        from kadhi_cli.utils.ebft_gdpo import apply_ebft_loss, apply_gdpo_loss
...
class TestMoeQuantUtils:
    ...
    def test_validate_moe_expert_quant_rejects(self, bad, exc):
        from kadhi_cli.utils.moe_quant import validate_moe_expert_quant

        with pytest.raises(exc):
            validate_moe_expert_quant(bad)

    def test_get_moe_expert_quant_spec_bits(self):
        from kadhi_cli.utils.moe_quant import get_moe_expert_quant_spec
    ...
    def test_moe_expert_quant_requires_moe_lora(self):
        from kadhi_cli.utils.moe_quant import validate_moe_expert_quant_compat
    ...
    def test_train_router_only_requires_moe_lora(self):
        from kadhi_cli.utils.moe_quant import validate_train_router_only_compat
    ...
    def test_apply_moe_expert_quant_lifted_v07120(self):
        ...
        from kadhi_cli.utils.moe_quant import apply_moe_expert_quant
...
class TestReasoningEffortUtils:
    def test_levels(self):
        from kadhi_cli.utils.reasoning_effort import (
...
class TestModuleSurface:
    ...
    def test_bitnet_metadata_mapping_proxy(self):
        from kadhi_cli.utils.bitnet import _BITNET_METADATA  # type: ignore

        assert isinstance(_BITNET_METADATA, MappingProxyType)

    def test_ebft_gdpo_metadata_mapping_proxy(self):
        from kadhi_cli.utils.ebft_gdpo import (  # type: ignore
            _EBFT_METADATA,
            _GDPO_METADATA,
        )
    ...
    def test_moe_quant_metadata_mapping_proxy(self):
        from kadhi_cli.utils.moe_quant import (  # type: ignore
...
class TestTddReviewGaps:
    ...
    def test_validate_gdpo_variant_full_matrix(self, bad, exc):
        from kadhi_cli.utils.ebft_gdpo import validate_gdpo_variant
...
class TestReviewFixes:
    ...
    def test_divergences_derived_from_aliases(self):
        from kadhi_cli.utils.distill import _DIVERGENCE_ALIASES, DIVERGENCES
