"""v0.63.0 Part D — kadhi ab mSPRT A/B harness tests."""
...
def test_module_imports():
    from kadhi_cli.utils import ab_test
...
def test_validate_metric_name_happy(m):
    from kadhi_cli.utils.ab_test import validate_metric_name
...
def test_msprt_config_defaults():
    from kadhi_cli.utils.ab_test import MsprtConfig
...
def test_msprt_verdict_frozen():
    from kadhi_cli.utils.ab_test import MsprtVerdict
...
def test_run_msprt_happy(tmp_path, monkeypatch):
    from kadhi_cli.utils.ab_test import MsprtConfig, run_msprt
