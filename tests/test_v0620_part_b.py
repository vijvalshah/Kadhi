...
class TestModuleSurface:
    def test_imports(self):
        from kadhi_cli.utils.ra_dit import (
    ...
    def test_stages_exact(self):
        from kadhi_cli.utils.ra_dit import SUPPORTED_RA_DIT_STAGES
    ...
    def test_metadata_mapping_proxy(self):
        ...
        from kadhi_cli.utils.ra_dit import _RA_DIT_STAGE_METADATA  # type: ignore
...
class TestStageSpec:
    def test_retriever_spec(self):
        from kadhi_cli.utils.ra_dit import get_ra_dit_stage_spec
...
# ---------- Cross-validator (KadhiConfig) ----------


class TestKadhiConfigGate:
