...
class TestVisionConfig:
    ...
    def test_modality_default_is_text(self):
        ...
        cfg = KadhiConfig(base="some-model", data={"train": "./data.jsonl"})
...
class TestSFTVisionIntegration:
    ...
    def test_sft_setup_vision_calls_automodel(self):
        ...
        with patch(
            "kadhi_cli.trainer.sft.SFTTrainerWrapper._setup_vision_transformers"
        ) as mock_setup:
...
class TestVisionTemplate:
    ...
    def test_vision_template_validates_as_config(self):
        """Vision template should validate as a KadhiConfig."""
        import yaml
...
class TestInitVisionTemplate:
    ...
    def test_init_vision_template(self):
        """kadhi init --template vision should create a valid config."""
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            output_path = Path(tmpdir) / "kadhi.yaml"
...
class TestDataInspectVision:
    ...
    def test_show_vision_stats_with_images(self):
        ...
        from kadhi_cli.commands.data import _show_vision_stats
        ...
        output = StringIO()
        with patch("kadhi_cli.commands.data.console", Console(file=output)):
...
class TestDoctorVision:
    ...
    def test_pillow_in_deps_list(self):
        ...
        from kadhi_cli.commands.doctor import DEPS
