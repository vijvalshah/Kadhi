"""v0.53.1 #109 — kadhi deploy autopilot --measure live wiring."""
...
class TestShaOfFile:
    def test_basic(self, tmp_path):
        from kadhi_cli.utils.deploy_measure import sha_of_file
...
class TestMeasureCandidate:
    def test_ok_when_after_matches(self, tmp_path):
        from kadhi_cli.utils.deploy_measure import measure_candidate
    ...
    def test_minor_band_at_3pct_drop(self, tmp_path):
        ...
        from kadhi_cli.utils.deploy_measure import MeasureResult, measure_candidate
...
class TestPickBest:
    def test_empty_returns_none(self):
        from kadhi_cli.utils.deploy_measure import pick_best

        assert pick_best([]) is None

    def test_first_ok_wins(self):
        from kadhi_cli.utils.deploy_measure import MeasureResult, pick_best
...
class TestCacheRoundtrip:
    def test_save_then_load(self, tmp_path):
        from kadhi_cli.utils.deploy_measure import load_cache, save_cache
    ...
    def test_load_missing_returns_empty(self, tmp_path):
        from kadhi_cli.utils.deploy_measure import load_cache
...
class TestRunMeasure:
    def test_first_run_misses_then_hits(self, tmp_path):
        from kadhi_cli.utils.deploy_measure import run_measure
...
class TestCacheSymlinkRejection:
    ...
    def test_save_cache_refuses_symlink_target(self, tmp_path):
        from kadhi_cli.utils.deploy_measure import save_cache
