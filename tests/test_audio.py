...
class TestAudioLoader:
    ...
    def test_validate_audio_files_resolves_paths(self, tmp_path):
        ...
        from kadhi_cli.data.loader import _validate_audio_files
...
class TestAudioInitTemplate:
    """Test that kadhi init --template audio works."""

    def test_init_audio_template_creates_file(self, tmp_path):
        """kadhi init --template audio should write a file with audio modality."""
    ...
    def test_init_audio_template_produces_valid_config(self, tmp_path):
        """The file written by kadhi init --template audio should parse."""
        from pathlib import Path
