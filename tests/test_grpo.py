...
class TestAccuracyReward:
    ...
    def test_exact_match(self):
        from kadhi_cli.trainer.rewards import accuracy_reward
...
class TestFormatReward:
    ...
    def test_perfect_format(self):
        from kadhi_cli.trainer.rewards import format_reward
...
class TestExtractAnswer:
    ...
    def test_hash_format(self):
        from kadhi_cli.trainer.rewards import _extract_answer
...
class TestLoadRewardFn:
    ...
    def test_load_builtin_accuracy(self):
        from kadhi_cli.trainer.rewards import accuracy_reward, load_reward_fn

        fn = load_reward_fn("accuracy")
        assert fn is accuracy_reward

    def test_load_builtin_format(self):
        from kadhi_cli.trainer.rewards import format_reward, load_reward_fn
...
class TestPrepareGRPODataset:
    ...
    def test_from_prompt_string(self):
        from kadhi_cli.trainer.grpo import _prepare_grpo_dataset
