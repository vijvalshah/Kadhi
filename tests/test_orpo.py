...
class TestORPOSweepParams:
    ...
    def test_sweep_run_single_routes_to_orpo_trainer(self):
        ...
        with mock_patch("kadhi_cli.data.loader.load_dataset", return_value=fake_dataset), \
             ...
             mock_patch("kadhi_cli.trainer.orpo.ORPOTrainerWrapper.setup"), \
             mock_patch(
                 "kadhi_cli.trainer.orpo.ORPOTrainerWrapper.train", return_value=fake_result
             ) as mock_train:
...
class TestORPOInitTemplate:
    """Test that kadhi init produces correct output for ORPO."""
