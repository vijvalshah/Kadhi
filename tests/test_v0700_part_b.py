...
class TestULDPublicSurface:
    ...
    def test_supported_strategies_frozenset(self):
        from kadhi_cli.utils.uld import SUPPORTED_ULD_STRATEGIES
...
class TestValidateULDStrategy:
    def test_happy_path(self):
        from kadhi_cli.utils.uld import validate_uld_strategy
...
class TestValidateProjectionDim:
    def test_happy_path(self):
        from kadhi_cli.utils.uld import validate_uld_projection_dim
