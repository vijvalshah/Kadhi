...
class TestEchoTrapPublicSurface:
    def test_module_imports(self):
        from kadhi_cli.utils import echo_trap
...
class TestTokenizedEchoSignal:
    def test_tokenized_repetition_catches_subword_echo_trap(self):
        from kadhi_cli.utils.echo_trap import (
    ...
    def test_tokenized_trajectory_rejects_non_int_ids(self):
        from kadhi_cli.utils.echo_trap import score_trajectory_repetition_tokenized
    ...
    def test_tokenized_batch_rejects_str(self):
        from kadhi_cli.utils.echo_trap import score_echo_signal_tokenized
...
class TestClassifyEchoSignal:
    ...
    def test_ok(self):
        from kadhi_cli.utils.echo_trap import classify_echo_signal
...
class TestEchoTrapReport:
    def test_basic(self):
        from kadhi_cli.utils.echo_trap import EchoTrapReport
