...
Tests for ``kadhi_cli/utils/vector_bank.py``:
...
class TestValidateBankName:
    def test_happy(self) -> None:
        from kadhi_cli.utils.vector_bank import validate_bank_name
...
class TestValidateScalingVector:
    def test_happy(self) -> None:
        from kadhi_cli.utils.vector_bank import validate_scaling_vector
    ...
    def test_oversize_rejected(self) -> None:
        from kadhi_cli.utils.vector_bank import MAX_VECTOR_DIM, validate_scaling_vector
...
class TestBankEntry:
    def test_construct(self) -> None:
        from kadhi_cli.utils.vector_bank import BankEntry
...
class TestVectorBank:
    ...
    def test_frozen(self) -> None:
        from kadhi_cli.utils.vector_bank import VectorBank
...
class TestEstimateBankSize:
    def test_basic(self) -> None:
        from kadhi_cli.utils.vector_bank import estimate_bank_size
...
class TestSourceWiring:
    def test_no_top_level_heavy_imports(self) -> None:
        ...
        src = (root / "src" / "kadhi_cli" / "utils" / "vector_bank.py").read_text(
            encoding="utf-8"
        )
        head_lines = [
            line
