"""Tests for kadhi data sample — intelligent dataset sampling."""
...
class TestSampleCLI:
    """Test kadhi data sample CLI command."""
...
class TestSampleStrategies:
    ...
    def test_random_sample(self):
        from kadhi_cli.commands.data import _sample_random
    ...
    def test_diverse_sample(self):
        from kadhi_cli.commands.data import _sample_diverse
    ...
    def test_hard_sample(self):
        from kadhi_cli.commands.data import _sample_hard
