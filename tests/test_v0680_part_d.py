"""v0.68.0 Part D — ``kadhi apple-adapter``.
...
class TestAllowlist:
    def test_frozenset(self) -> None:
        from kadhi_cli.utils.apple_adapter import SUPPORTED_ADAPTER_DIRECTIONS
...
class TestValidateSourceAdapter:
    def test_happy(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        from kadhi_cli.utils.apple_adapter import validate_source_adapter
