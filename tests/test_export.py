"""Tests for kadhi export command."""
...
from kadhi_cli.commands.export import (
    GGUF_QUANT_TYPES,
    SUPPORTED_FORMATS,
    _detect_base_model,
...
def test_find_quantize_binary_not_found(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr("kadhi_cli.commands.export.shutil.which", lambda _name: None)
...
def test_find_quantize_binary_on_path(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr(
        "kadhi_cli.commands.export.shutil.which",
