...
class TestDatasetRegistry:
    ...
    def test_register_dataset(self, tmp_path):
        ...
        from kadhi_cli.utils.registry import (
            load_registry,
            register_dataset,
        )
    ...
    def test_resolve_registered_name(self, tmp_path):
        ...
        from kadhi_cli.utils.registry import register_dataset, resolve_dataset
    ...
    def test_resolve_unregistered_name(self, tmp_path):
        ...
        from kadhi_cli.utils.registry import resolve_dataset
...
class TestRegistryCLI:
    """Tests for `kadhi data register/unregister/list` CLI commands."""

    @patch("kadhi_cli.commands.data._get_registry_path")
