...
def test_module_imports():
    from kadhi_cli.utils import interference
...
def test_verdicts_closed():
    from kadhi_cli.utils.interference import INTERFERENCE_VERDICTS
...
def test_compute_interference_zero_when_identical_loss():
    from kadhi_cli.utils.interference import compute_interference
...
def test_render_matrix_json_rejects_non_matrix():
    from kadhi_cli.utils.interference import render_matrix_json
...
def test_render_matrix_markdown_empty_cells():
    from kadhi_cli.utils.interference import InterferenceMatrix, render_matrix_markdown
...
def test_render_matrix_markdown_rejects_non_matrix():
    from kadhi_cli.utils.interference import render_matrix_markdown
