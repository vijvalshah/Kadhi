"""Tests for v0.61.0 Part C — `kadhi edit set` (ROME / MEMIT / AlphaEdit).
...
class TestModuleSurface:
    def test_imports(self):
        from kadhi_cli.utils.knowledge_edit import (
...
class TestParseEditSubjectTarget:
    def test_happy_path(self):
        from kadhi_cli.utils.knowledge_edit import parse_edit_subject_target
...
class TestApplyEdit:
    def test_live_dispatch(self, monkeypatch):
        ...
        from kadhi_cli.utils.knowledge_edit import EditResult, apply_edit, build_edit_plan
    ...
    def test_unknown_method_in_plan_short_circuits(self):
        from kadhi_cli.utils.knowledge_edit import apply_edit
...
class TestCli:
    ...
    def test_edit_set_apply_failure_exit2(self, monkeypatch):
        ...
        import kadhi_cli.utils.knowledge_edit as ke
