...
class TestQATUtils:
    ...
    def test_is_qat_available_returns_bool(self):
        ...
        from kadhi_cli.utils.qat import is_qat_available
    ...
    def test_prepare_model_for_qat_calls_quantize(self):
        ...
        with patch.dict("sys.modules", {
            ...
            import kadhi_cli.utils.qat

            importlib.reload(kadhi_cli.utils.qat)
            result = kadhi_cli.utils.qat.prepare_model_for_qat(mock_model)
    ...
    def test_get_qat_config_returns_config(self):
        ...
        with patch.dict("sys.modules", {
            ...
            importlib.reload(kadhi_cli.utils.qat)
            result = kadhi_cli.utils.qat.get_qat_config()
...
class TestSFTQATIntegration:
    ...
    def test_sft_setup_transformers_calls_qat(self):
        ...
        with patch("kadhi_cli.utils.qat.prepare_model_for_qat",
    ...
    def test_sft_setup_transformers_no_qat_when_disabled(self):
        ...
        with patch("kadhi_cli.utils.qat.prepare_model_for_qat") as mock_qat:
...
class TestQATExportCompatibility:
    ...
    def test_qat_config_does_not_affect_export(self):
        ...
        from kadhi_cli.commands.export import GGUF_QUANT_TYPES, SUPPORTED_FORMATS
