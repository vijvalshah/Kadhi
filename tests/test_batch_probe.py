...
class TestProbeLoop:
    def test_converges_when_capacity_below_start(self):
        ...
        from kadhi_cli.utils.batch_probe import probe_batch_size
...
class TestCache:
    ...
    def test_save_and_load_roundtrip(self, tmp_path, monkeypatch):
        from kadhi_cli.utils.batch_probe import (
            load_cache,
            make_cache_key,
            save_cache_entry,
        )
        ...
        monkeypatch.setenv("KADHI_BATCH_CACHE_PATH", str(cache_path))
    ...
    def test_load_corrupt_returns_empty(self, tmp_path, monkeypatch):
        from kadhi_cli.utils.batch_probe import load_cache
    ...
    def test_save_rejects_non_positive_value(self, tmp_path, monkeypatch):
        from kadhi_cli.utils.batch_probe import make_cache_key, save_cache_entry
...
class TestCachePathContainment:
    def test_out_of_bounds_override_falls_back_to_default(
        ...
        from kadhi_cli.utils.batch_probe import _cache_path
        ...
        if os.name == "nt":
            ...
            evil = "/etc/cron.d/kadhi_evil"
        monkeypatch.setenv("KADHI_BATCH_CACHE_PATH", evil)
        path = _cache_path()
