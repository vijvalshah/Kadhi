...
class TestAdapterValidation:
    ...
    def test_valid_adapter_name(self):
        from kadhi_cli.commands.serve import _validate_adapter_name
    ...
    def test_adapter_path_traversal_protection(self, tmp_path):
        from kadhi_cli.commands.serve import _validate_adapter_path
...
class TestParseAdapters:
    ...
    def test_parse_single_adapter(self):
        from kadhi_cli.commands.serve import _parse_adapters
