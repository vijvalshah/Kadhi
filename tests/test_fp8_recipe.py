...
class TestFP8RecipeDispatch:
    ...
    def test_apply_fp8_dispatches_tensorwise(self):
        ...
        with patch.dict(
            ...
            import kadhi_cli.utils.fp8 as fp8_mod
    ...
    def test_apply_fp8_returns_false_when_unavailable(self):
        ...
        with patch("kadhi_cli.utils.fp8.is_fp8_available", return_value=False):
            model = MagicMock()
...
class TestFP8RecipeViaV028Features:
    ...
    def _run_dispatch(self, recipe: str) -> MagicMock:
        ...
        with patch("kadhi_cli.utils.fp8.apply_fp8_training", return_value=True) as m:
    ...
    def test_v028_skips_apply_when_quant_not_fp8(self):
        ...
        with patch("kadhi_cli.utils.fp8.apply_fp8_training") as m:
            from kadhi_cli.utils.v028_features import apply_v028_speed_memory
