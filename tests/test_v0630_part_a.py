"""v0.63.0 Part A — kadhi ingest universal trace importer tests."""
...
def test_module_imports():
    from kadhi_cli.utils import ingest_sources  # noqa: F401
...
def test_supported_sources_exact():
    from kadhi_cli.utils.ingest_sources import SUPPORTED_INGEST_SOURCES
...
def test_trace_record_frozen():
    from kadhi_cli.utils.ingest_sources import TraceRecord
...
def test_validate_source_name_happy():
    from kadhi_cli.utils.ingest_sources import validate_source_name
...
def test_parse_langsmith_basic():
    from kadhi_cli.utils.ingest_sources import parse_langsmith
...
def test_parse_helicone_basic():
    from kadhi_cli.utils.ingest_sources import parse_helicone
...
def test_parse_openpipe_basic():
    from kadhi_cli.utils.ingest_sources import parse_openpipe
...
def test_parse_otel_basic():
    from kadhi_cli.utils.ingest_sources import parse_otel
...
def test_parse_openai_stored_basic():
    from kadhi_cli.utils.ingest_sources import parse_openai_stored
...
def test_ingest_traces_dispatches_to_parser(tmp_path, monkeypatch):
    ...
    from kadhi_cli.utils.ingest_sources import ingest_traces
...
def test_ingest_traces_caps_lines(tmp_path, monkeypatch):
    ...
    from kadhi_cli.utils import ingest_sources
