"""Tests for kadhi data generate — synthetic data generation."""
...
class TestBuildGenerationPrompt:
    ...
    def test_prompt_includes_format_spec(self):
        ...
        from kadhi_cli.commands.generate import _build_generation_prompt
...
class TestRowToText:
    ...
    def test_row_to_text_basic(self):
        ...
        from kadhi_cli.commands.generate import _row_to_text
