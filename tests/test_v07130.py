...
from kadhi_cli.utils.prm_reward import (
    AGGREGATE_MODES,
...
class TestLoadRewardHeadWeights:
    def test_loads_head_from_safetensors(self, tmp_path):
        ...
        from kadhi_cli.utils.prm_reward import load_reward_head_weights
    ...
    def test_missing_head_rejected(self, tmp_path):
        ...
        with pytest.raises(ValueError, match="reward_head|Kadhi-trained PRM"):
...
def _make_fake_scorer(aggregate="min"):
    ...
    from kadhi_cli.utils.prm_reward import PRMScorer
...
class TestBuildPrmRewardFn:
    def test_returns_named_scorer(self, monkeypatch):
        import kadhi_cli.utils.prm_reward as mod
...
class TestResolveTrust:
    def test_delegates_with_requires_flag(self, monkeypatch):
        import kadhi_cli.utils.trust_remote as trust_mod
        from kadhi_cli.utils.prm_reward import _resolve_trust
...
class TestEnvs:
    ...
    def test_rows_normalise(self, modname):
        ...
        mod = importlib.import_module(f"kadhi_cli.envs.{modname}")
        rows = mod.rollout([])
    ...
    def test_calculator_answers_correct(self):
        ...
        from kadhi_cli.envs.calculator import rollout
    ...
    def test_guess_number_answer_matches_product(self):
        ...
        from kadhi_cli.envs.guess_number import rollout
    ...
    def test_retrieval_qa_answer_matches_asked_fact(self):
        ...
        from kadhi_cli.envs.retrieval_qa import rollout
    ...
    def test_row_count_is_default(self, modname):
        ...
        from kadhi_cli.envs._common import DEFAULT_ROWS
    ...
    def test_envs_produce_distinct_output(self):
        ...
        from kadhi_cli.envs import calculator, guess_number, retrieval_qa
...
class TestGrpoPrmWiring:
    def test_prm_reward_selected(self, monkeypatch):
        import kadhi_cli.trainer.grpo as grpo

        sentinel = object()
        monkeypatch.setattr(
            "kadhi_cli.utils.prm_reward.build_prm_reward_fn",
    ...
    def test_standard_reward_selected(self, monkeypatch):
        ...
        monkeypatch.setattr("kadhi_cli.trainer.rewards.load_reward_fn", _fake_load)
...
class TestRecipes:
    ...
    def test_recipe_yaml_parses(self, name):
        ...
        assert cfg.training.rollout_func.startswith("kadhi_cli.envs.")
...
class TestBuildPrmTrainResult:
    def test_has_all_summary_keys(self):
        from kadhi_cli.trainer.prm import build_prm_train_result
