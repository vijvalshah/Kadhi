...
from kadhi_cli.utils import encoding as enc
...
def test_cli_bootstrap_calls_force_utf8(monkeypatch):
    """kadhi_cli.cli imports `force_utf8_stdio` so it runs at module load."""
...
def test_writers_use_utf8_encoding():
    ...
    audited_files = [
        "src/kadhi_cli/commands/quickstart.py",
        "src/kadhi_cli/commands/init.py",
        "src/kadhi_cli/commands/migrate.py",
    ]
