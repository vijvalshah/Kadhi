"""Tests for kadhi diff — model comparison command."""
...
class TestCollectPrompts:
    ...
    def test_collect_from_text_file(self, tmp_path):
        ...
        from kadhi_cli.commands.diff import _collect_prompts
...
class TestComputeMetrics:
    ...
    def test_identical_responses(self):
        ...
        from kadhi_cli.commands.diff import _compute_metrics
...
class TestDisplaySummary:
    ...
    def test_display_summary_no_crash(self):
        ...
        from kadhi_cli.commands.diff import _display_summary
