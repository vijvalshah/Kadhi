...
Kadhi bug nine frames inside get_peft_model.

Fix lives in kadhi_cli.utils.errors.ERROR_MAP, following the existing
...
def test_torchao_version_error_is_mapped_to_actionable_fix():
    ...
    # Explains Kadhi does not need it unless QAT is configured.
