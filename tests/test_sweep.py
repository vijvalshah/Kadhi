"""Tests for kadhi sweep — hyperparameter search."""
...
class TestParseSweepParams:
    ...
    def test_parse_simple_float_params(self):
        ...
        from kadhi_cli.commands.sweep import _parse_sweep_params
...
class TestParseValue:
    ...
    def test_parse_int(self):
        from kadhi_cli.commands.sweep import _parse_value
...
class TestGenerateCombinations:
    ...
    def test_grid_search(self):
        ...
        from kadhi_cli.commands.sweep import _generate_combinations
