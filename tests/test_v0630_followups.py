...
def test_msprt_step_zero_variance_returns_continue():
    ...
    more samples arrive.
    """
    from kadhi_cli.utils.ab_test import MsprtConfig, msprt_step
...
def test_detect_common_prefix_partial_majority_binary_search_activates():
    ...
    """
    from kadhi_cli.utils.prune_prompt import detect_common_prefix
...
def test_score_uncertainty_max_entropy_at_0_5_is_exactly_1_0():
    ...
    from kadhi_cli.utils.active_sampler import score_uncertainty
...
def test_rolling_kl_identical_distributions_is_near_zero():
    ...
    from kadhi_cli.utils.drift_alarm import rolling_kl
...
def test_validate_budget_exact_lower_boundary_one_accepted():
    from kadhi_cli.utils.active_sampler import validate_budget
...
def test_validate_threshold_exact_boundary_100_0_accepted():
    from kadhi_cli.utils.drift_alarm import validate_threshold
...
def test_signal_from_thumbs_exact_numeric_boundaries():
    ...
    from kadhi_cli.utils.ingest_sources import _signal_from_thumbs
...
_V0630_UTIL_MODULES = (
    "src/kadhi_cli/utils/ingest_sources.py",
    "src/kadhi_cli/utils/prune_prompt.py",
    "src/kadhi_cli/utils/active_sampler.py",
    "src/kadhi_cli/utils/ab_test.py",
    "src/kadhi_cli/utils/drift_alarm.py",
)
...
def test_v0630_no_heavy_top_level_imports(module_path):
    ...
    need them. A regression here would make `kadhi --help` slow to import.
    """
