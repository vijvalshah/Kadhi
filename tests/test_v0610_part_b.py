...
- ``kadhi eval unlearning`` CLI smoke.
"""
...
class TestModuleSurface:
    def test_imports(self):
        from kadhi_cli.utils.unlearning_eval import (
            BENCHMARKS,
            VERDICTS,
            UnlearnMetric,
            UnlearnReport,
    ...
    def test_benchmarks_exact(self):
        from kadhi_cli.utils.unlearning_eval import BENCHMARKS

        assert BENCHMARKS == frozenset({"tofu", "muse", "wmdp"})

    def test_verdicts_exact(self):
        from kadhi_cli.utils.unlearning_eval import VERDICTS
...
class TestClassifyUnlearnScore:
    def test_ok_boundary(self):
        from kadhi_cli.utils.unlearning_eval import classify_unlearn_score
...
class TestValidateBenchmarkName:
    def test_happy_path(self):
        from kadhi_cli.utils.unlearning_eval import validate_benchmark_name
...
class TestComputeForgetQuality:
    def test_perfect_forget(self):
        ...
        # forget quality = 1.0.
        from kadhi_cli.utils.unlearning_eval import compute_forget_quality
...
class TestComputeModelUtility:
    def test_perfect_utility(self):
        ...
        from kadhi_cli.utils.unlearning_eval import compute_model_utility
...
class TestComputePrivLeak:
    def test_no_leak(self):
        ...
        from kadhi_cli.utils.unlearning_eval import compute_priv_leak
...
class TestUnlearnMetric:
    def test_construct(self):
        from kadhi_cli.utils.unlearning_eval import UnlearnMetric
...
class TestUnlearnReport:
    def test_construct(self):
        from kadhi_cli.utils.unlearning_eval import UnlearnMetric, UnlearnReport
...
class TestRunUnlearnEval:
    def test_happy_path(self):
        from kadhi_cli.utils.unlearning_eval import run_unlearn_eval
...
class TestLoadEvidenceFile:
    """v0.71.1 — cover the `kadhi eval unlearning --evidence` loader."""

    def test_happy_returns_dict(self, tmp_path, monkeypatch):
        from kadhi_cli.utils.unlearning_eval import load_evidence_file
...
class TestFixtures:
    def test_tofu_fixture_exists(self):
        from kadhi_cli.utils.unlearning_eval import get_fixture_path
    ...
    def test_all_benchmarks_resolve_a_fixture(self):
        from kadhi_cli.utils.unlearning_eval import BENCHMARKS, get_fixture_path
    ...
    def test_wmdp_fixture_is_valid_jsonl(self):
        ...
        # REFUSED placeholder with its hazardous content redacted — Kadhi never
    ...
    def test_metadata_fixtures_are_filenames_not_paths(self):
        from kadhi_cli.utils.unlearning_eval import _BENCHMARK_METADATA
