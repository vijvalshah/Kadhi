...
touches CUDA before Kadhi does makes the setting a no-op — which is exactly what
...
class TestExpandableSegmentsStatus:
    def test_windows_says_windows(self, monkeypatch):
        from kadhi_cli.utils.layer_stream_runtime import expandable_segments_status
