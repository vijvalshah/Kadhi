...
class TestNormBlowupPolicy:
    def test_defaults(self):
        from kadhi_cli.utils.edit_governor import NormBlowupPolicy
...
class TestClassifyNormBlowup:
    def test_ok_band(self):
        from kadhi_cli.utils.edit_governor import classify_norm_blowup
...
class TestGovernorRecommendMethod:
    def test_no_switch_below_threshold(self):
        from kadhi_cli.utils.edit_governor import governor_recommend_method
