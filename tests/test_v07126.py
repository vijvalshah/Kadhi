...
def _yaml(
    ...
    *,
    ...
    """Minimal KadhiConfig YAML that exercises the mitigation gate."""
    lines = [
...
class TestMitigationLogWriter:
    ...
    def test_records_one_line_per_call(self, tmp_path, monkeypatch):
        ...
        from kadhi_cli.utils.reward_hack_control import MitigationLogWriter
...
class TestControllerState:
    ...
    def test_defaults(self):
        from kadhi_cli.utils.reward_hack_control import ControllerState
...
class TestCombineSignals:
    ...
    def test_mean(self):
        from kadhi_cli.utils.reward_hack_control import combine_signals
...
class TestSmoothSignal:
    ...
    def test_none_returns_new(self):
        from kadhi_cli.utils.reward_hack_control import smooth_signal
...
class TestTelemetryHelpers:
    ...
    def test_mean_token_len(self):
        from kadhi_cli.utils.reward_hack_control import mean_token_len
    ...
    def test_reward_mean_std(self):
        from kadhi_cli.utils.reward_hack_control import reward_mean_std
    ...
    def test_mean_repetition_detects_repeats(self):
        from kadhi_cli.utils.reward_hack_control import mean_repetition
...
class TestRewardHackLastDropPct:
    ...
    def test_last_drop_pct_baseline_zero(self):
        from kadhi_cli.utils.reward_hacking import RewardHackCallback
...
class TestSyntheticRewards:
    ...
    def _load(self):
        ...
        spec = importlib.util.spec_from_file_location("kadhi_synth_rewards", path)
...
class TestAttachMitigationWiring:
    ...
    def test_attach_builds_mitigation_callback(self, tmp_path, monkeypatch):
        ...
        from kadhi_cli.utils.reward_hack_control import RewardHackMitigationCallback
...
def _bang_policy(**kw):
    from kadhi_cli.utils.reward_hack_control import BangBangPolicy
...
def _run_bang(policy, votes, beta0=None):
    from kadhi_cli.utils.reward_hack_control import ControllerState, bang_bang_step
...
class TestPpoBufferParity:
    ...
    def test_ppo_setup_wires_buffer_and_mitigation(self):
        ...
        from kadhi_cli.trainer import ppo
...
class TestRewardHackMitigationCli:
    """`kadhi train --reward-hack-mitigation <mode>` flag + re-exec passthrough."""
    ...
    def test_reexec_passthrough_present(self):
        ...
        from kadhi_cli.commands import train as train_mod
...
def _pid_policy(**kw):
    from kadhi_cli.utils.reward_hack_control import PIDLagrangianPolicy
...
def _run_pid(policy, signals, beta0=None):
    from kadhi_cli.utils.reward_hack_control import ControllerState, pid_step
...
class TestAttachPidControl:
    ...
    def test_attach_pid_builds_policy_and_ckpt_ref(self, tmp_path, monkeypatch):
        ...
        from kadhi_cli.utils.peft_wiring import attach_rl_callbacks
        from kadhi_cli.utils.reward_hack_control import RewardHackMitigationCallback
        from kadhi_cli.utils.rl_checkpoint import RLCheckpointCallback
...
class TestConservativeAndDrift:
    ...
    def test_conservative_agreement_uses_mean(self):
        from kadhi_cli.utils.reward_hack_control import combine_conservative
...
class TestRewardShaping:
    ...
    def test_length_penalises_long(self):
        from kadhi_cli.utils.reward_hack_control import shape_reward_fn
...
class TestExplainGiveup:
    ...
    def test_names_signal_and_attempts(self):
        from kadhi_cli.utils.reward_hack_control import ControllerState, explain_giveup
...
class TestRewardShapingWiring:
    ...
    def test_grpo_applies_shaping(self):
        ...
        from kadhi_cli.trainer import grpo
...
class TestReviewFixesTdd:
    ...
    def test_shape_reward_verbatim_on_shim_error(self, monkeypatch):
        ...
        import kadhi_cli.utils.reward_hack_control as rhc
    ...
    def test_drift_negative_gap(self):
        from kadhi_cli.utils.reward_hack_control import detect_reward_distribution_drift
    ...
    def test_record_action_caps_at_max(self, tmp_path, monkeypatch):
        monkeypatch.chdir(tmp_path)
        from kadhi_cli.utils.reward_hack_control import _MAX_ACTION_HISTORY
    ...
    def test_no_top_level_heavy_import_in_source(self):
        ...
        from kadhi_cli.utils import reward_hack_control
