...
class TestTtsCodecPackage:
    def test_per_family_packages(self):
        from kadhi_cli.utils.tts import TTS_CODEC_PACKAGES, tts_codec_package
    ...
    def test_case_insensitive(self):
        from kadhi_cli.utils.tts import tts_codec_package
    ...
    def test_packages_immutable(self):
        from kadhi_cli.utils.tts import TTS_CODEC_PACKAGES
...
class TestFormatTtsMessages:
    ...
    def test_no_emotion_passthrough(self):
        from kadhi_cli.utils.tts import format_tts_messages
...
class TestBuildBitnetTrainer:
    ...
    def test_returns_wrapper(self):
        from kadhi_cli.config.loader import load_config_from_string
        from kadhi_cli.trainer.bitnet import BitNetTrainerWrapper
        from kadhi_cli.utils.bitnet import build_bitnet_trainer
...
class TestBitnetGgufQuantArg:
    def test_maps_to_tq1_0(self):
        from kadhi_cli.utils.bitnet import _BITNET_GGUF_QUANT_ARG
...
class TestMoeRouterDetection:
    ...
    def test_is_router_param(self, name, is_router):
        from kadhi_cli.utils.moe_quant import _is_router_param
...
class TestMoeExpertHelpers:
    ...
    def test_find_expert_linears(self):
        from kadhi_cli.utils.moe_quant import _find_expert_linears
    ...
    def test_freeze_experts_train_router(self):
        from kadhi_cli.utils.moe_quant import freeze_experts_train_router
...
class TestApplyMoeFeaturesIfConfigured:
    ...
    def test_quant_noop_when_unset(self):
        from kadhi_cli.utils.moe_quant import apply_moe_expert_quant_if_configured
    ...
    def test_freeze_noop_when_unset(self):
        from kadhi_cli.utils.moe_quant import apply_router_only_freeze_if_configured
    ...
    def test_quant_prints_when_set(self, monkeypatch):
        ...
        from kadhi_cli.utils import moe_quant
