...
class TestRegistry:
    def test_lists_known_templates(self):
        from kadhi_cli.data.chat_templates import list_template_names
    ...
    def test_chatml_is_jinja_string(self):
        from kadhi_cli.data.chat_templates import get_template
    ...
    def test_resolve_returns_jinja_for_known_name(self):
        from kadhi_cli.data.chat_templates import resolve_chat_template
...
class TestApplyOverride:
    ...
    def test_override_emits_save_pretrained_warning(self):
        ...
        assert "save_pretrained" in buf.getvalue() or "kadhi push" in buf.getvalue()
