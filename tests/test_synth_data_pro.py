...
class TestNewProvidersValidation:
    ...
    def test_ollama_provider_accepted(self):
        ...
        from kadhi_cli.commands.generate import VALID_PROVIDERS
...
class TestOllamaProvider:
    ...
    def test_detect_ollama_success(self):
        ...
        from kadhi_cli.data.providers.ollama import detect_ollama
    ...
    def test_generate_ollama_calls_api(self):
        ...
        from kadhi_cli.data.providers.ollama import generate_ollama
...
class TestOllamaSSRF:
    ...
    def test_blocks_remote_url(self):
        ...
        from kadhi_cli.data.providers.ollama import validate_ollama_url
...
class TestAnthropicProvider:
    ...
    def test_generate_anthropic_calls_api(self):
        ...
        from kadhi_cli.data.providers.anthropic import generate_anthropic
...
class TestVLLMProvider:
    ...
    def test_generate_vllm_calls_api(self):
        ...
        from kadhi_cli.data.providers.vllm import generate_vllm
...
class TestVLLMSSRF:
    ...
    def test_blocks_non_http_scheme(self):
        """Non-HTTP scheme should be rejected."""
        from kadhi_cli.data.providers.vllm import validate_vllm_url
...
class TestAnthropicHardcodedURL:
    ...
    def test_api_url_is_anthropic(self):
        ...
        from kadhi_cli.data.providers.anthropic import ANTHROPIC_API_URL
...
class TestParseJsonArrayShared:
    ...
    def test_parse_valid_array(self):
        ...
        from kadhi_cli.data.providers._utils import parse_json_array
...
class TestBatchRoutingNewProviders:
    ...
    def test_routes_to_ollama(self):
        ...
        from kadhi_cli.commands.generate import _generate_batch

        with mock_patch(
            "kadhi_cli.data.providers.ollama.generate_ollama",
    ...
    def test_routes_to_anthropic(self):
        ...
        with mock_patch(
            "kadhi_cli.data.providers.anthropic.generate_anthropic",
            return_value=[{"instruction": "x", "output": "y"}],
        ) as mock_anthropic:
            result = _generate_batch(
                prompt="test", count=1, fmt="alpaca",
    ...
    def test_routes_to_vllm(self):
        ...
        with mock_patch(
            "kadhi_cli.data.providers.vllm.generate_vllm",
            return_value=[{"instruction": "x", "output": "y"}],
        ) as mock_vllm:
            result = _generate_batch(
                prompt="test", count=1, fmt="alpaca",
    ...
    def test_old_providers_still_route(self):
        ...
        for prov, mock_target in [
            ("openai", "kadhi_cli.commands.generate._generate_openai"),
            ("local", "kadhi_cli.commands.generate._generate_local"),
            ("server", "kadhi_cli.commands.generate._generate_server"),
        ]:
...
class TestTemplateValidation:
    ...
    def test_valid_templates(self):
        ...
        from kadhi_cli.commands.generate import VALID_TEMPLATES
...
class TestCodeTemplate:
    ...
    def test_build_prompt_default(self):
        ...
        from kadhi_cli.data.templates.code import build_prompt
    ...
    def test_template_spec_has_languages(self):
        ...
        from kadhi_cli.data.templates.code import TEMPLATE_SPEC
...
class TestConversationTemplate:
    ...
    def test_build_prompt_default(self):
        ...
        from kadhi_cli.data.templates.conversation import build_prompt
...
class TestQATemplate:
    ...
    def test_build_prompt_without_context(self):
        ...
        from kadhi_cli.data.templates.qa import build_prompt
...
class TestPreferenceTemplate:
    ...
    def test_build_prompt_dpo(self):
        ...
        from kadhi_cli.data.templates.preference import build_prompt
...
class TestReasoningTemplate:
    ...
    def test_build_prompt_math(self):
        ...
        from kadhi_cli.data.templates.reasoning import build_prompt
    ...
    def test_valid_domains(self):
        ...
        from kadhi_cli.data.templates.reasoning import DOMAINS
...
class TestTemplateBuildPromptIntegration:
    ...
    def test_code_template_integration(self):
        ...
        from kadhi_cli.commands.generate import _build_template_prompt
...
class TestValidatePipeline:
    ...
    def test_removes_invalid_entries(self, tmp_path):
        ...
        from kadhi_cli.commands.generate import _run_validate_pipeline
...
class TestFilterPipeline:
    ...
    def test_filter_pipeline_runs(self, tmp_path):
        ...
        from kadhi_cli.commands.generate import _run_filter_pipeline
...
class TestDedupPipeline:
    ...
    def test_dedup_pipeline_without_datasketch(self, tmp_path):
        ...
        from kadhi_cli.commands.generate import _run_dedup_pipeline
...
class TestValidatePreference:
    ...
    def test_dpo_format_valid(self):
        ...
        from kadhi_cli.commands.generate import _validate_preference
...
class TestPathWithinCwd:
    ...
    def test_path_within_cwd(self, tmp_path):
        ...
        from kadhi_cli.commands.generate import _path_within_cwd
...
class TestOutputPathSanitization:
    ...
    def test_path_traversal_blocked_in_cli(self):
        ...
        with mock_patch(
            "kadhi_cli.commands.generate._generate_batch",
            return_value=[{"instruction": "x", "output": "y"}],
        ):
            result = runner.invoke(app, [
                "data", "generate",
...
class TestGetFormatSpec:
    ...
    def test_alpaca_spec(self):
        ...
        from kadhi_cli.commands.generate import _get_format_spec
...
class TestEndToEndGeneration:
    ...
    def test_generate_with_ollama_provider(self, tmp_path):
        ...
        with mock_patch(
            ...
            "kadhi_cli.commands.generate._path_within_cwd",
            return_value=True,
        ):
            runner = CliRunner()
            result = runner.invoke(app, [
    ...
    def test_generate_with_template(self, tmp_path):
        ...
        with mock_patch(
            "kadhi_cli.commands.generate._generate_server",
            return_value=[
