...
class TestCutCEAvailability:
    ...
    def test_check_cut_ce_available_returns_bool(self):
        from kadhi_cli.utils.cut_ce import check_cut_ce_available
    ...
    def test_get_cut_ce_version_not_installed(self):
        from kadhi_cli.utils.cut_ce import get_cut_ce_version
...
class TestCutCEApplication:
    ...
    def test_apply_cut_ce_not_installed(self):
        from kadhi_cli.utils.cut_ce import apply_cut_ce

        with patch(
            "kadhi_cli.utils.cut_ce.check_cut_ce_available", return_value=False
        ):
    ...
    def test_apply_cut_ce_available_tries_patching(self):
        ...
        with patch(
            "kadhi_cli.utils.cut_ce.check_cut_ce_available", return_value=True
        ):
    ...
    def test_apply_cut_ce_calls_llama_patch_for_llama_model(self):
        ...
        with patch(
            ...
            "kadhi_cli.utils.cut_ce._detect_model_type", return_value=""
        ), patch.dict(
            "sys.modules",
            {
...
class TestCutCEDetectsArchitectureFromTheConfig:
    ...
    no-opped on every local checkpoint directory Kadhi itself produces
    ...
    def test_a_local_checkpoint_dir_with_no_architecture_in_its_name_is_still_detected(
        ...
        from kadhi_cli.utils import cut_ce as cut_ce_mod
    ...
    def test_config_model_type_wins_over_a_conflicting_directory_name(
        ...
        outcome on names that happen to agree. A ``kadhi merge``/``kadhi
...
class TestIssue456CrossPlatformPathComponentExtraction:
    ...
    def test_windows_parent_dir_with_architecture_keyword_does_not_overmatch_liger(
        ...
        from kadhi_cli.utils import liger as liger_mod
...
class TestCutCEUnifiedMessage:
    ...
    def test_sft_and_v028_features_reference_the_shared_constant(self):
        ...
        import kadhi_cli.trainer.sft as sft_mod
        import kadhi_cli.utils.v028_features as v028_mod
...
class TestCutCEValidation:
    ...
    def test_validate_cut_ce_disabled_returns_empty(self):
        from kadhi_cli.utils.cut_ce import validate_cut_ce_config
...
class TestFP8Availability:
    ...
    def test_is_fp8_available_returns_bool(self):
        from kadhi_cli.utils.fp8 import is_fp8_available
    ...
    def test_fp8_requires_hopper_gpu_info(self):
        ...
        from kadhi_cli.utils.fp8 import is_fp8_gpu_supported
...
class TestFP8Validation:
    ...
    def test_validate_fp8_not_requested_returns_empty(self):
        from kadhi_cli.utils.fp8 import validate_fp8_config
...
class TestGradientCheckpointingResolver:
    ...
    def test_resolve_disabled_returns_empty(self):
        from kadhi_cli.utils.gradient_ckpt import resolve_gradient_checkpointing
    ...
    def test_resolve_selective_tier(self):
        from kadhi_cli.utils.gradient_ckpt import (
    ...
    def test_resolve_auto_medium_memory_selects_medium(self):
        from kadhi_cli.utils.gradient_ckpt import resolve_granularity
    ...
    def test_describe_tier_off(self):
        from kadhi_cli.utils.gradient_ckpt import describe_tier
...
class TestKernelPickerEnumerate:
    ...
    def test_enumerate_returns_list(self):
        from kadhi_cli.utils.kernel_picker import enumerate_kernel_combos
...
class TestKernelPickerDecision:
    ...
    def test_pick_best_returns_dict(self):
        from kadhi_cli.utils.kernel_picker import pick_best_kernel
...
class TestCrossDocAttnMaskBuild:
    ...
    def test_build_mask_single_doc(self):
        from kadhi_cli.utils.cross_doc_attn import build_cross_doc_mask
    ...
    def test_compute_doc_boundaries_empty(self):
        from kadhi_cli.utils.cross_doc_attn import compute_doc_boundaries
...
class TestActivationOffloadingValidation:
    ...
    def test_validate_none_returns_empty(self):
        from kadhi_cli.utils.activation_offload import validate_offload_config
...
class TestActivationOffloadingHooks:
    ...
    def test_context_manager_noop_when_none(self):
        from kadhi_cli.utils.activation_offload import offload_context
...
class TestV028SFTOnlyValidator:
    ...
    The KadhiConfig validator rejects non-SFT tasks when speed/memory flags
