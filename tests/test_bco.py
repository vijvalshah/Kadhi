...
class TestSplitDpoRowsToBco:
    def test_two_rows_become_four_with_correct_labels(self):
        from kadhi_cli.trainer.bco import _split_dpo_rows_to_bco
    ...
    def test_skipped_rows_logged_at_debug(self, caplog):
        ...
        caplog.set_level(logging.DEBUG, logger="kadhi_cli.trainer.bco")
...
class TestBCOTrainRouting:
    ...
    def test_sweep_routes_to_bco_trainer(self):
        ...
        with mock_patch(
            ...
            "kadhi_cli.trainer.bco.BCOTrainerWrapper.setup",
        ), mock_patch(
            "kadhi_cli.trainer.bco.BCOTrainerWrapper.train",
