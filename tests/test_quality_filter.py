...
class TestScoreCoherenceInternal:
    ...
    def test_none_text_returns_zero(self):
        ...
        from kadhi_cli.utils.quality import _score_coherence
...
class TestFilterByQuality:
    ...
    def test_empty_data_returns_empty(self):
        ...
        from kadhi_cli.utils.quality import filter_by_quality
    ...
    def test_perplexity_filter_requires_model(self):
        ...
        with mock_patch(
            "kadhi_cli.utils.quality.compute_perplexity_scores",
            return_value=[50.0],
        ):
            kept, removed = filter_by_quality(
...
class TestFilterCommand:
    """Test the kadhi data filter CLI command."""

    def test_filter_command_exists(self):
        """kadhi data filter should be a registered command."""
    ...
    def test_filter_requires_threshold_or_score_only(self):
        """kadhi data filter should require at least one filter option."""
        from typer.testing import CliRunner
    ...
    def test_filter_file_not_found(self):
        """kadhi data filter should fail gracefully for missing file."""
        from typer.testing import CliRunner
    ...
    def test_filter_with_coherence(self, tmp_path):
        """kadhi data filter --coherence should filter low-quality rows."""
        import json
    ...
    def test_filter_score_only(self, tmp_path):
        """kadhi data filter --score-only should add scores without removing rows."""
        import json
