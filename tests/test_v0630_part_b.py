"""v0.63.0 Part B — kadhi prune-prompt static prefix detector tests."""
...
def test_module_imports():
    from kadhi_cli.utils import prune_prompt
...
def test_validate_min_frequency_happy(value):
    from kadhi_cli.utils.prune_prompt import validate_min_frequency
...
def test_prune_prompt_report_frozen():
    from kadhi_cli.utils.prune_prompt import PrunePromptReport
