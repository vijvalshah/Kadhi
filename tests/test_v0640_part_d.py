...
def test_module_imports():
    from kadhi_cli.utils import hardware_fit
...
def test_safety_margin_is_10pct():
    from kadhi_cli.utils.hardware_fit import VRAM_SAFETY_MARGIN
...
def test_validate_seq_len_happy(v):
    from kadhi_cli.utils.hardware_fit import validate_seq_len
...
def test_validate_batch_size_happy(v):
    from kadhi_cli.utils.hardware_fit import validate_batch_size
...
def test_vram_breakdown_frozen():
    from kadhi_cli.utils.hardware_fit import VRAMBreakdown
...
def test_estimate_peak_vram_returns_breakdown():
    from kadhi_cli.utils.hardware_fit import HardwareFitInput, VRAMBreakdown, estimate_peak_vram_gb
...
def test_no_heavy_top_level_imports():
    ...
    src = Path(__file__).resolve().parent.parent / "src" / "kadhi_cli" / "utils" / "hardware_fit.py"
