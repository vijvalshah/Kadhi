"""Tests for kadhi serve — inference server command."""
...
class TestCreateApp:
    ...
    def test_chat_completions_endpoint(self):
        ...
        with patch("kadhi_cli.commands.serve._generate_response") as mock_gen:
...
class TestStreamResponse:
    ...
    def test_stream_response_yields_chunks(self):
        ...
        from kadhi_cli.commands.serve import _stream_response
...
class TestDetectBaseModel:
    ...
    def test_detect_base_model_from_adapter(self, tmp_path):
        ...
        from kadhi_cli.commands.serve import _detect_base_model
...
# v0.71.1 #230 — kadhi serve --record-thumbs
