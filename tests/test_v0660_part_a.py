...
def test_hf_hub_allowlist_is_frozenset():
    from kadhi_cli.utils.sae_diff import HF_HUB_ALLOWLIST
...
def test_validate_sae_repo_happy():
    from kadhi_cli.utils.sae_diff import HF_HUB_ALLOWLIST, validate_sae_repo
...
def test_validate_sae_repo_rejects_unknown():
    from kadhi_cli.utils.sae_diff import validate_sae_repo
...
def test_encode_activations_returns_correct_shape():
    from kadhi_cli.utils.sae_diff import encode_activations
...
def test_compute_sae_diff_happy(tmp_path):
    from kadhi_cli.utils.sae_diff import compute_sae_diff
...
def test_render_report_json_rejects_non_report():
    from kadhi_cli.utils.sae_diff import render_report_json
...
def test_render_report_markdown_rejects_non_report():
    from kadhi_cli.utils.sae_diff import render_report_markdown
...
def test_render_report_markdown_empty_changes():
    from kadhi_cli.utils.sae_diff import SaeFeatureDiffReport, render_report_markdown
