...
class TestCodebookConfig:
    def test_happy(self):
        from kadhi_cli.utils.grace_codebook import build_grace_codebook_config
...
class TestApplyDeferred:
    ...
    def test_apply_validates_config_type(self):
        from kadhi_cli.utils.grace_codebook import apply_grace_codebook
...
class TestEditMethodAllowlist:
    def test_grace_in_supported_methods(self):
        from kadhi_cli.utils.knowledge_edit import SUPPORTED_EDIT_METHODS

        assert "grace" in SUPPORTED_EDIT_METHODS

    def test_grace_method_validates(self):
        from kadhi_cli.utils.knowledge_edit import validate_edit_method

        assert validate_edit_method("grace") == "grace"
        assert validate_edit_method("GRACE") == "grace"

    def test_grace_spec_present(self):
        from kadhi_cli.utils.knowledge_edit import get_edit_method_spec
...
# ---------- KadhiConfig cross-validator ----------


class TestKadhiConfigCrossValidator:
