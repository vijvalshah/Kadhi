...
``kadhi probe pack <base>`` assembles a pack of calibrated probes for a
...
def test_module_imports():
    from kadhi_cli.utils import probe_pack
...
def test_probe_kinds_frozen():
    from kadhi_cli.utils.probe_pack import PROBE_KINDS
...
def test_list_probe_bases_sorted():
    from kadhi_cli.utils.probe_pack import BUNDLED_PACKS, list_probe_bases
...
def test_validate_pack_base_happy():
    from kadhi_cli.utils.probe_pack import BUNDLED_PACKS, validate_pack_base
...
def test_validate_pack_base_unknown_raises():
    from kadhi_cli.utils.probe_pack import validate_pack_base
...
def test_probe_pack_rejects_empty_probes():
    from kadhi_cli.utils.probe_pack import ProbePack

    with pytest.raises(ValueError, match="at least"):
        ProbePack(base="b", probes=tuple(), kadhi_version="0.66.0")
...
def test_probe_pack_rejects_duplicate_probe_names():
    ...
    with pytest.raises(ValueError, match="duplicate"):
        ProbePack(base="b", probes=(e1, e2), kadhi_version="0.66.0")
...
def test_get_probe_pack_happy():
    from kadhi_cli.utils.probe_pack import BUNDLED_PACKS, ProbePack, get_probe_pack
...
def test_get_probe_pack_unknown_raises():
    from kadhi_cli.utils.probe_pack import get_probe_pack
...
def test_get_probe_pack_case_insensitive():
    from kadhi_cli.utils.probe_pack import BUNDLED_PACKS, get_probe_pack
...
def test_render_pack_json_rejects_non_pack():
    from kadhi_cli.utils.probe_pack import render_pack_json
...
def test_render_pack_markdown_rejects_non_pack():
    from kadhi_cli.utils.probe_pack import render_pack_markdown
