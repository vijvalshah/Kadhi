"""v0.67.0 Part D — ``kadhi adapters pr`` (GitHub-shaped PR rendering).

Tests for ``kadhi_cli/utils/adapter_pr.py``:
...
class TestEvalDelta:
    def test_construct(self) -> None:
        from kadhi_cli.utils.adapter_pr import EvalDelta
...
class TestSampleDiff:
    def test_construct(self) -> None:
        from kadhi_cli.utils.adapter_pr import SampleDiff
    ...
    def test_oversize_truncated(self) -> None:
        from kadhi_cli.utils.adapter_pr import MAX_OUTPUT_LEN, SampleDiff
...
class TestAdapterPR:
    def test_construct(self) -> None:
        from kadhi_cli.utils.adapter_pr import AdapterPR, EvalDelta, SampleDiff
    ...
    def test_frozen(self) -> None:
        from kadhi_cli.utils.adapter_pr import AdapterPR
...
class TestBuildAdapterPR:
    def test_happy(self) -> None:
        from kadhi_cli.utils.adapter_pr import build_adapter_pr
...
class TestRenderPR:
    def test_markdown_structure(self) -> None:
        from kadhi_cli.utils.adapter_pr import AdapterPR, EvalDelta, SampleDiff, render_pr_markdown
    ...
    def test_markdown_escapes_markdown_metacharacters(self) -> None:
        from kadhi_cli.utils.adapter_pr import AdapterPR, EvalDelta, render_pr_markdown
    ...
    def test_non_pr_rejected(self) -> None:
        from kadhi_cli.utils.adapter_pr import render_pr_json, render_pr_markdown
...
class TestWritePR:
    def test_write_markdown(self, tmp_path, monkeypatch) -> None:
        from kadhi_cli.utils.adapter_pr import AdapterPR, write_pr_markdown
...
class TestSourceWiring:
    def test_no_top_level_heavy_imports(self) -> None:
        ...
        src = (root / "src" / "kadhi_cli" / "utils" / "adapter_pr.py").read_text(
            encoding="utf-8"
        )
        head_lines = [
            line
