"""Tests for v0.61.0 Part E — `kadhi edit diff` (knowledge-injection diff).
...
class TestDataclasses:
    def test_imports(self):
        from kadhi_cli.utils.edit_diff import (
            DiffReport,
            FactChange,
            build_diff_report,
            load_probes,
    ...
    def test_fact_change_frozen(self):
        from kadhi_cli.utils.edit_diff import FactChange
    ...
    def test_diff_report_frozen(self):
        from kadhi_cli.utils.edit_diff import DiffReport, FactChange
    ...
    def test_diff_report_validates_changes_tuple(self):
        from kadhi_cli.utils.edit_diff import DiffReport
...
class TestLoadProbes:
    ...
    def test_happy_path(self, tmp_path):
        from kadhi_cli.utils.edit_diff import load_probes
...
class TestRenderDiffTable:
    ...
    def test_non_report_rejected(self):
        ...
        from kadhi_cli.utils.edit_diff import render_diff_table
...
class TestWriteDiffReport:
    ...
    def test_non_report_rejected(self, tmp_path):
        from kadhi_cli.utils.edit_diff import write_diff_report
