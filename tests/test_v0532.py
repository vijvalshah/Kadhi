...
class TestReasoningEffortPrefix:
    def test_inserts_system_message_when_none(self) -> None:
        from kadhi_cli.utils.reasoning_effort import apply_reasoning_effort_prefix
...
class TestEbftLossLive:
    def test_structured_returns_finite_scalar(self) -> None:
        ...
        from kadhi_cli.utils.ebft_gdpo import apply_ebft_loss
...
class TestGdpoLossLive:
    def test_standard_returns_finite_scalar(self) -> None:
        torch = _torch_or_skip()
        from kadhi_cli.utils.ebft_gdpo import apply_gdpo_loss
...
class TestAttachGdpoComputeLoss:
    def test_no_op_when_variant_unset(self) -> None:
        from kadhi_cli.utils.ebft_gdpo import attach_gdpo_compute_loss
...
class TestDistillWrapper:
    def test_imports_cleanly(self) -> None:
        from kadhi_cli.trainer.distill import DistillTrainerWrapper  # noqa: F401
...
class TestClassifierWrapperHelpers:
    def test_row_to_text_with_text_field(self) -> None:
        from kadhi_cli.trainer.classifier import _row_to_text
    ...
    def test_row_to_pair_text_ab(self) -> None:
        from kadhi_cli.trainer.classifier import _row_to_pair
    ...
    def test_label_index_int_in_range(self, idx: int) -> None:
        from kadhi_cli.trainer.classifier import _label_index
    ...
    def test_normalise_label_multi_label_from_list(self) -> None:
        from kadhi_cli.trainer.classifier import _normalise_label
...
class TestClassifierWrapper:
    def test_imports_cleanly(self) -> None:
        from kadhi_cli.trainer.classifier import ClassifierTrainerWrapper  # noqa: F401
...
class TestEbftAttachIdempotent:
    def test_double_wrap_is_no_op(self) -> None:
        ...
        assert getattr(trainer, "_kadhi_ebft_wrapped", False) is True
...
class TestGdpoAttachIdempotent:
    def test_double_wrap_is_no_op(self) -> None:
        ...
        assert first is True
        assert second is False
        assert getattr(trainer, "_kadhi_gdpo_wrapped", False) is True
...
class TestExtendMaskIdempotency:
    ...
    def test_second_pass_no_op(self) -> None:
        from kadhi_cli.data.loss_mask import _extend_mask_to_eot
...
class TestResolveEosTokenId:
    ...
    def test_int(self) -> None:
        from kadhi_cli.data.loss_mask import _resolve_eos_token_id
...
class TestDistillSourceLevelGuards:
    ...
    def test_uses_seq2seq_collator(self) -> None:
        ...
        from kadhi_cli.trainer import distill as distill_mod
