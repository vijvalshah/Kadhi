"""Tests for --tensorboard flag in kadhi train command."""
...
class TestTensorBoardImportCheck:
    ...
    def test_tensorboard_flag_checks_import(self, tmp_path):
        ...
        with mock_patch(
            "kadhi_cli.commands.train.typer",
...
class TestTensorBoardSweepRouting:
    ...
    def test_sweep_run_single_with_tensorboard_report_to(self):
        ...
        with mock_patch("kadhi_cli.data.loader.load_dataset", return_value=fake_dataset), \
             ...
             mock_patch("kadhi_cli.trainer.sft.SFTTrainerWrapper.setup"), \
             mock_patch(
                 "kadhi_cli.trainer.sft.SFTTrainerWrapper.train", return_value=fake_result
             ):
