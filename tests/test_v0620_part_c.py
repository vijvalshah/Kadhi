"""Tests for v0.62.0 Part C — `kadhi steer` (CAA / ITI / RepE control vectors).
...
class TestModuleSurface:
    ...
    def test_methods_exact(self):
        from kadhi_cli.utils.steering import SUPPORTED_STEERING_METHODS
    ...
    def test_metadata_mapping_proxy(self):
        ...
        from kadhi_cli.utils.steering import _STEERING_METHOD_METADATA  # type: ignore
...
class TestValidateMethod:
    def test_happy(self):
        from kadhi_cli.utils.steering import validate_steering_method
...
class TestSpec:
    def test_caa_spec(self):
        from kadhi_cli.utils.steering import get_steering_method_spec
...
# ---------- kadhi serve --steer flag plumbing ----------
