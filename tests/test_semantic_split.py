"""Tests for Semantic Stratified Splitting in `kadhi data split`."""
...
class TestSemanticSplit:
    ...
    def test_semantic_split_row_limit(self, tmp_path, monkeypatch):
        ...
        import kadhi_cli.commands.data as data_mod
    ...
    def test_semantic_stratification_distribution(self, tmp_path, monkeypatch):
        ...
        coding_texts = [
            ...
            "web scraping beautifulkadhi scrapy parse html page python",
