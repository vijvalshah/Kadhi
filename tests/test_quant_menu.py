...
class TestGPTQConfigBuilder:
    def test_build_gptq_config_disables_exllama_when_flag_true(self):
        from kadhi_cli.utils.quant_menu import build_gptq_config
...
class TestGPTQValidator:
    def test_gptq_train_requires_existing_quantize_config(self, tmp_path):
        from kadhi_cli.utils.quant_menu import validate_gptq_checkpoint
...
"""
    ...
    def test_build_awq_config_returns_dict(self):
        from kadhi_cli.utils.quant_menu import build_awq_config
    ...
    def test_validate_awq_checkpoint_local_missing(self, tmp_path):
        from kadhi_cli.utils.quant_menu import validate_awq_checkpoint
...
"""
    ...
    def test_build_hqq_config_extracts_bits(self):
        from kadhi_cli.utils.quant_menu import build_hqq_config
...
"""
    ...
    def test_build_aqlm_config_forces_2bit(self):
        from kadhi_cli.utils.quant_menu import build_aqlm_config
...
"""
    ...
    def test_build_eetq_config_forces_8bit(self):
        from kadhi_cli.utils.quant_menu import build_eetq_config
...
"""
    ...
    def test_build_mxfp4_config_uses_bnb_4bit(self):
        from kadhi_cli.utils.quant_menu import build_mxfp4_config
...
"""
    ...
    def test_build_fp8_dequant_config_sets_dequantize(self):
        from kadhi_cli.utils.quant_menu import build_fp8_dequant_config
...
# ---------------------------------------------------------------------------
# KadhiConfig-level cross-validator tests (Quant Menu task/backend/modality gate)
# ---------------------------------------------------------------------------
...
class TestBuilderAdversarial:
    ...
    def test_parse_hqq_bits_oversized_suffix_rejected(self):
        from kadhi_cli.utils.quant_menu import parse_hqq_bits
