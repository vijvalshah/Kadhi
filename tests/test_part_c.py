...
class TestApplyV028SpeedMemory:
    ...
    def test_cut_ce_failure_logs_yellow(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            "kadhi_cli.utils.cut_ce.apply_cut_ce", _boom, raising=False,
        )
    ...
    def test_warn_unsupported_returns_none_for_supported(self):
        from kadhi_cli.utils.v028_features import warn_unsupported_features
...
class TestInstallSelectiveHooks:
    def test_unknown_granularity_rejected(self):
        from kadhi_cli.utils.gradient_ckpt import install_selective_hooks
...
class TestCrossDocCollator:
    def test_requires_base_collator(self):
        from kadhi_cli.data.collators import CrossDocCollator
