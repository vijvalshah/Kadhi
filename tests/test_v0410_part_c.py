...
from kadhi_cli.config.schema import LoraConfig, KadhiConfig, TrainingConfig
...
from kadhi_cli.utils.loftq_init import (
    build_loftq_config,
    validate_loftq_bits,
    validate_loftq_iter,
)
...
# ---------- Full KadhiConfig integration ----------

class TestKadhiConfigIntegration:
