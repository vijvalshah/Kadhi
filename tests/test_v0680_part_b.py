"""v0.68.0 Part B — ``kadhi distill-prompt``.
...
class TestPublicSurface:
    def test_module_importable(self) -> None:
        from kadhi_cli.utils import prompt_distill
...
class TestAllowlist:
    def test_frozenset(self) -> None:
        from kadhi_cli.utils.prompt_distill import SUPPORTED_DISTILL_STRATEGIES
...
class TestValidateStrategy:
    def test_happy(self) -> None:
        from kadhi_cli.utils.prompt_distill import validate_distill_strategy
...
class TestValidateModelId:
    def test_teacher_happy(self) -> None:
        from kadhi_cli.utils.prompt_distill import validate_teacher_id
...
class TestValidateTracesPath:
    def test_happy(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        from kadhi_cli.utils.prompt_distill import validate_traces_path
...
class TestDistillPromptPlan:
    def test_frozen(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        from kadhi_cli.utils.prompt_distill import DistillPromptPlan
