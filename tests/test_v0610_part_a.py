"""Tests for v0.61.0 Part A — `kadhi unlearn` trainer (NPO / SimNPO / RMU).
...
class TestModuleSurface:
    def test_imports(self):
        from kadhi_cli.utils.unlearning import (
    ...
    def test_supported_methods_exact(self):
        from kadhi_cli.utils.unlearning import SUPPORTED_UNLEARN_METHODS
    ...
    def test_metadata_mapping_proxy(self):
        ...
        from kadhi_cli.utils.unlearning import _UNLEARN_METHOD_METADATA  # type: ignore
...
class TestGetUnlearnMethodSpec:
    def test_happy_path(self):
        from kadhi_cli.utils.unlearning import get_unlearn_method_spec
...
class TestBuildUnlearnTrainer:
    ...
    def test_returns_wrapper_instance(self):
        ...
        from kadhi_cli.utils.unlearning import build_unlearn_trainer
    ...
    def test_invalid_config_rejected(self):
        ...
        with pytest.raises(AttributeError, match="KadhiConfig"):
...
class TestSourceWiring:
    def test_cli_registers_edit_typer(self):
        ...
        cli_src = Path(__file__).resolve().parent.parent / "src" / "kadhi_cli" / "cli.py"
    ...
    def test_eval_registers_v0610(self):
        ...
        eval_src = (
            ...
            / "src" / "kadhi_cli" / "commands" / "eval.py"
        )
