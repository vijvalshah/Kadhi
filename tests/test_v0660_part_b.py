...
def test_run_blame_no_longer_raises_not_implemented_when_probe_supplied():
    ...
    from kadhi_cli.utils.blame import BlameResult, run_blame
...
def test_compute_row_influence_zero_when_orthogonal():
    from kadhi_cli.utils.blame import compute_row_influence
...
def test_blame_result_top_influencers_must_be_tuple():
    from kadhi_cli.utils.blame import BlameResult, RowInfluence
...
def test_run_blame_returns_top_influencers():
    from kadhi_cli.utils.blame import run_blame
...
def test_render_blame_json_roundtrip():
    from kadhi_cli.utils.blame import BlameResult, RowInfluence, render_blame_json
...
def test_render_blame_json_rejects_non_result():
    from kadhi_cli.utils.blame import render_blame_json
...
def test_render_blame_markdown_has_table():
    from kadhi_cli.utils.blame import BlameResult, RowInfluence, render_blame_markdown
...
def test_render_blame_markdown_rejects_non_result():
    from kadhi_cli.utils.blame import render_blame_markdown
