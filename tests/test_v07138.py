"""v0.71.38 — "The gate grows teeth": make `kadhi ship`'s regression leg real.
...
class TestScoreAnswerBoundary:
    ...
    def test_substring_within_word_no_longer_matches(self):
        from kadhi_cli.eval.forgetting import score_answer
...
class TestExtractMcqLetter:
    def test_cue_form(self):
        from kadhi_cli.eval.forgetting import extract_mcq_letter
    ...
    def test_leading_letter_beats_trailing_pronoun_or_article(self):
        from kadhi_cli.eval.forgetting import extract_mcq_letter, score_answer
...
class TestForgettingDetectorUsesNewScorer:
    ...
    def test_clean_letter_output_still_scores(self):
        from kadhi_cli.eval.forgetting import MINI_MMLU, ForgettingDetector
...
class TestExpandedMcqSuites:
    ...
    def test_suites_present_and_large_enough(self):
        from kadhi_cli.eval.forgetting import MINI_BENCHMARKS
    ...
    def test_mcq_items_well_formed(self):
        from kadhi_cli.eval.forgetting import MINI_BENCHMARKS, score_answer
...
class TestBundledSuiteRegistry:
    ...
    def test_is_bundled_suite(self):
        from kadhi_cli.eval.gate_suites import is_bundled_suite
...
class TestBundledScorers:
    def test_score_mcq_suite_via_dispatch(self):
        from kadhi_cli.eval.forgetting import MINI_BENCHMARKS
        from kadhi_cli.eval.gate_suites import score_bundled_suite
    ...
    def test_score_tool_call_suite(self):
        from kadhi_cli.eval.gate_suites import load_suite_items, score_bundled_suite
...
class TestShipLeg2Dispatch:
    def test_default_suite_is_full_bundled_set(self):
        from kadhi_cli.commands.ship import _parse_suite
    ...
    def test_leg2_scores_behavioural_suites_without_lm_eval(self):
        ...
        from kadhi_cli.eval.gate_suites import load_suite_items
    ...
    def test_safety_under_refusal_is_a_regression_through_the_pipeline(self):
        ...
        from kadhi_cli.commands.ship import _leg2_scores
        from kadhi_cli.utils.ship_verdict import compute_benchmark_deltas
...
class TestShipLiveHeadline:
    """A full `kadhi ship` run where leg 1 IMPROVES but leg 2 catches a
    ...
    def test_clean_tune_ships_through_full_default_suite(self, monkeypatch):
        ...
        from kadhi_cli.eval.gate_suites import DEFAULT_GENERAL_SUITE, load_suite_items
...
class TestExitCodeTaxonomy:
    ...
    def test_pairwise_mode_is_accepted(self):
        ...
        from kadhi_cli.commands.ship import _validate_task_mode_flag
...
class TestDiagnoseExports:
    def test_seven_probes_documented(self):
        import kadhi_cli.utils.diagnose as diag
