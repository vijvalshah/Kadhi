...
`kadhi data inspect <file>` prints the detected format and stats for any of them.

## Getting real data

```bash
kadhi data search "instruction tuning"      # find datasets on the HF Hub
kadhi data preview <dataset-id>             # splits + features, before downloading
kadhi data download <dataset-id> -o out.jsonl
kadhi data demo                             # list bundled demo fixtures (same files as these)
```
...
`kadhi advise <data> --goal "..."` reads your data and says which of these you're in.
